(function ($) {
    ...
    function init(plot) {
        var canvas = null, target = null, options = null, maxRadius = null, centerLeft = null, centerTop = null,
            processed = false, ctx = null;
        var highlights = [];
        ...
        function draw(plot, newCtx) {
            ...
            var canvasWidth = plot.getPlaceholder().width(), canvasHeight = plot.getPlaceholder().height(),
        ...
        function findNearbySlice(mouseX, mouseY) {
            var slices = plot.getData(), options = plot.getOptions(),
            ...
            for (var i = 0; i < slices.length; ++i) {
                ...
                if (s.pie.show) {
                    ...
                    if (ctx.isPointInPath) {
                        ...
                        var p1X = radius * Math.cos(s.startAngle), p1Y = radius * Math.sin(s.startAngle),
