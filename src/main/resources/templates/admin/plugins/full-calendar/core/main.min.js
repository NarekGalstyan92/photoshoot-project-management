!function (e, t) {
    ...
    function t(e, t, n) {
        ...
        if (t) for (var i in t) "style" === i ? g(r, t[i]) : ci[i] ? r[i] = t[i] : r.setAttribute(i, t[i]);
    ...
    function y(e, t, n) {
        null == n ? e.style[t] = "" : "number" == typeof n && hi.test(t) ? e.style[t] = n + "px" : e.style[t] = n
    }
    ...
    function R() {
        ...
        var n = e.firstChild, r = n.getBoundingClientRect().left > e.getBoundingClientRect().left;
        return c(e), r
    }
    ...
    function C(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = I(e.offsetWidth - e.clientWidth - r - i),
            u = I(e.offsetHeight - e.clientHeight - o - a), l = {
                borderLeft: r,
                borderRight: i,
                borderTop: o,
                borderBottom: a,
    ...
    function $(e, t, n) {
        var r = e.getUTCFullYear(), i = ee(e, r, t, n);
    ...
    function ee(e, t, n, r) {
        var i = oe([t, 0, 1 + te(t, n, r)]), o = X(e), a = Math.round(F(i, o));
    ...
    function be(e, t) {
        for (var n = null, r = 0; r < mi.length; r++) {
            var i = mi[r];
            if (t[i]) {
                var o = e[i] / t[i];
    ...
    function Re(e, t) {
        t.left && g(e, {borderLeftWidth: 1, marginLeft: t.left - 1}), t.right && g(e, {
            borderRightWidth: 1,
    ...
    function Ie(e) {
        g(e, {marginLeft: "", marginRight: "", borderLeftWidth: "", borderRightWidth: ""})
    }
    ...
    function ke(e, t, n) {
        ...
        Oe(e), e.forEach(function (t, n) {
            ...
            var n = t === o.length - 1 ? i : r, u = a[t], l = s[t], c = n - (u - l);
    ...
    function Pe(e, t) {
        ...
        g(e, n), g(t, n);
        var r = e.offsetHeight - t.offsetHeight, i = {position: "", left: ""};
    ...
    function Xe(e) {
        var t = Math.floor(F(e.start, e.end)) || 1, n = X(e.start);
        return {start: n, end: V(n, t)}
    }
    ...
    function Je(e, t) {
        ...
        return e.start && (n = X(e.start), r && r <= n && (r = V(n, 1))), {start: n, end: r}
    }
    ...
    function $e(e, t, n, r, i) {
        for (var o = 0; o < r.length; o++) {
            var a = r[o].parse(e, t, i, n);
            if (a) return {allDay: a.allDay, duration: a.duration, typeData: a.typeData, typeId: o}
        }
        return null
    }

    function et(e, t, n, r) {
        var i = r[e.recurringDef.typeId], o = i.expand(e.recurringDef.typeData, e, t, n);
    ...
    function st(e, t, n, r) {
        for (var i = ht(), o = 0, a = e; o < a.length; o++) {
            var s = a[o], u = kn(s, t, n, r);
            u && ut(u, i)
        }
        return i
    }
    ...
    function ut(e, t) {
        return void 0 === t && (t = ht()), t.defs[e.def.defId] = e.def, e.instance && (t.instances[e.instance.instanceId] = e.instance), t
    }
    ...
    function lt(e, t, n) {
        ...
        for (var a in i) {
            var s = i[a];
            if (s.recurringDef) {
                var u = et(s, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes), l = s.recurringDef.duration;
                l || (l = s.allDay ? n.defaultAllDayEventDuration : n.defaultTimedEventDuration);
                for (var c = 0, d = u; c < d.length; c++) {
                    var f = d[c], p = _n(a, {start: f, end: r.add(f, l)});
                    o[p.instanceId] = p
                }
            }
        }
    ...
    function ct(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], i = gt(e, function (e) {
                return dt(r, e)
            });
    ...
    function ft(e, t, n) {
        ...
        return i && (e = pt(e, i)), r && (e = pt(e, r)), e
    }
    ...
    function vt(e, t) {
        return {defs: Di({}, e.defs, t.defs), instances: Di({}, e.instances, t.instances)}
    }

    function gt(e, t) {
        var n = rt(e.defs, t), r = rt(e.instances, function (e) {
            return n[e.defId]
        });
    ...
    function mt(e, t) {
        var n, r, i = [], o = t.start;
        for (e.sort(Et), n = 0; n < e.length; n++) r = e[n], r.start > o && i.push({
            start: o,
            end: r.start
        }), r.end > o && (o = r.end);
    ...
    function Mt(e) {
        var t, n;
        return function () {
            return t && Ct(t, arguments) || (t = arguments, n = e.apply(this, arguments)), n
        }
    }
    ...
    function Ot(e, t, n) {
        ...
        return 1 === r && "short" === e.timeZoneName ? function (e) {
            ...
            return Nt(n.computeWeekNumber(e.marker), n.weekLabel, n.locale, t.week)
        } : _t(e, t, n)
    }

    function _t(e, t, n) {
        e = Di({}, e), t = Di({}, t), Pt(e, t), e.timeZone = "UTC";
    ...
    function xt(e, t, n, r, i) {
        return e = e.replace(Ci, ""), "short" === n.timeZoneName && (e = Ht(e, "UTC" === i.timeZone || null == t.timeZoneOffset ? "UTC" : Ft(t.timeZoneOffset))), r.omitCommas && (e = e.replace(Ri, "").trim()), r.omitZeroMinute && (e = e.replace(":00", "")), !1 === r.meridiem ? e = e.replace(wi, "").trim() : "narrow" === r.meridiem ? e = e.replace(wi, function (e, t) {
            return t.toLocaleLowerCase()
        }) : "short" === r.meridiem ? e = e.replace(wi, function (e, t) {
            return t.toLocaleLowerCase() + "m"
        }) : "lowercase" === r.meridiem && (e = e.replace(wi, function (e) {
    ...
    function Ht(e, t) {
        var n = !1;
        return e = e.replace(Mi, function () {
            return n = !0, t
        }), n || (e += " " + t), e
    }
    ...
    function Ut(e, t) {
        var n = {};
        for (var r in e) r in bi && !(bi[r] <= t) || (n[r] = e[r]);
        return n
    }
    ...
    function Vt(e, t) {
        return "object" == typeof e && e ? ("string" == typeof t && (e = Di({separator: t}, e)), new ki(e)) : "string" == typeof e ? new Oi(e, t) : "function" == typeof e ? new _i(e) : void 0
    }
    ...
    function Wt(e, t, n, r) {
        var i = Zt(e, n.calendarSystem);
        return {
            date: i,
            start: i,
            end: t ? Zt(t, n.calendarSystem) : null,
            timeZone: n.timeZone,
    ...
    function jt(e, t, n, r) {
        var i = {}, o = {}, a = {}, s = [], u = [], l = Jt(e.defs, t);
        for (var c in e.defs) {
            var d = e.defs[c];
            "inverse-background" === d.rendering && (d.groupId ? (i[d.groupId] = [], a[d.groupId] || (a[d.groupId] = d)) : o[c] = [])
        }
        for (var f in e.instances) {
            var p = e.instances[f], d = e.defs[p.defId], h = l[d.defId], v = p.range, g = !d.allDay && r ? Je(v, r) : v,
                y = St(g, n);
        ...
        for (var m in i) for (var E = i[m], S = mt(E, n), D = 0, T = S; D < T.length; D++) {
            var b = T[D], d = a[m], h = l[d.defId];
            s.push({def: d, ui: h, instance: null, range: b, isStart: !1, isEnd: !1})
        }
        for (var c in o) for (var E = o[c], S = mt(E, n), w = 0, R = S; w < R.length; w++) {
            var b = R[w];
    ...
    function qt(e, t, n) {
        e.hasPublicHandlers("eventRender") && (t = t.filter(function (t) {
            var r = e.publiclyTrigger("eventRender", [{
                event: new xi(e.calendar, t.eventRange.def, t.eventRange.instance),
                isMirror: n,
                isStart: t.isStart,
                isEnd: t.isEnd,
                el: t.el,
    ...
    function Kt(e, t) {
        var n = [];
        return t[""] && n.push(t[""]), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Cn(n)
    }

    function Qt(e, t, n, r) {
        var i = Jt(e.defs, t), o = ht();
        for (var a in e.defs) {
            var s = e.defs[a];
            o.defs[a] = $t(s, i[a], n, r.pluginSystem.hooks.eventDefMutationAppliers, r)
        }
        for (var u in e.instances) {
            var l = e.instances[u], s = o.defs[l.defId];
            o.instances[u] = tn(l, s, i[l.defId], n, r)
        }
        return o
    }
    ...
    function $t(e, t, n, r, i) {
        ...
        null == o.hasEnd && t.durationEditable && en(t.startEditable ? n.startDelta : null, n.endDelta || null) && (o.hasEnd = !0);
        var a = Di({}, e, o, {ui: Di({}, e.ui, o.ui)});
        n.extendedProps && (a.extendedProps = Di({}, a.extendedProps, n.extendedProps));
    ...
    function tn(e, t, n, r, i) {
        var o = i.dateEnv, a = r.standardProps && !0 === r.standardProps.allDay,
            s = r.standardProps && !1 === r.standardProps.hasEnd, u = Di({}, e);
        ...
        } : !r.endDelta || !n.durationEditable && en(n.startEditable ? r.startDelta : null, r.endDelta) || (u.range = {
            start: u.range.start,
    ...
    function nn(e, t, n, r, i) {
        switch (t.type) {
            case"RECEIVE_EVENTS":
                return rn(e, n[t.sourceId], t.fetchId, t.fetchRange, t.rawEvents, i);
            case"ADD_EVENTS":
                return on(e, t.eventStore, r ? r.activeRange : null, i);
            case"MERGE_EVENTS":
                return vt(e, t.eventStore);
            case"PREV":
            case"NEXT":
            case"SET_DATE":
            case"SET_VIEW_TYPE":
                return r ? lt(e, r.activeRange, i) : e;
            case"CHANGE_TIMEZONE":
                return an(e, t.oldDateEnv, i.dateEnv);
            case"MUTATE_EVENTS":
                return sn(e, t.instanceId, t.mutation, t.fromApi, i);
            case"REMOVE_EVENT_INSTANCES":
                return ln(e, t.instances);
            case"REMOVE_EVENT_DEF":
                return gt(e, function (e) {
                    return e.defId !== t.defId
                });
            case"REMOVE_EVENT_SOURCE":
                return un(e, t.sourceId);
    ...
    function rn(e, t, n, r, i, o) {
        if (t && n === t.latestFetchId) {
            var a = st(ft(i, t, o), t.sourceId, o);
            return r && (a = lt(a, r, o)), vt(un(e, t.sourceId), a)
        }
        return e
    }

    function on(e, t, n, r) {
        return n && (t = lt(t, n, r)), vt(e, t)
    }

    function an(e, t, n) {
        var r = e.defs, i = it(e.instances, function (e) {
            var i = r[e.defId];
            return i.allDay || i.recurringDef ? e : Di({}, e, {
                range: {
    ...
    function ln(e, t) {
        return {
            defs: e.defs, instances: rt(e.instances, function (e) {
    ...
    function cn(e, t) {
        return fn({eventDrag: e}, t)
    }

    function dn(e, t) {
        return fn({dateSelection: e}, t)
    }

    function fn(e, t) {
        var n = t.view, r = Di({
            businessHours: n ? n.props.businessHours : ht(),
            dateSelection: "",
        ...
        return (t.pluginSystem.hooks.isPropsValid || pn)(r, t)
    }

    function pn(e, t, n, r) {
        return void 0 === n && (n = {}), !(e.eventDrag && !hn(e, t, n, r)) && !(e.dateSelection && !vn(e, t, n, r))
    }

    function hn(e, t, n, r) {
        var i = e.eventDrag, o = i.mutatedEvents, a = o.defs, s = o.instances,
            u = Jt(a, i.isEvent ? e.eventUiBases : {"": t.selectionConfig});
        r && (u = it(u, r));
        var l = ln(e.eventStore, i.affectedEvents.instances), c = l.defs, d = l.instances, f = Jt(c, e.eventUiBases);
        for (var p in s) {
            var h = s[p], v = h.range, g = u[h.defId], y = a[h.defId];
            if (!gn(g.constraints, v, l, e.businessHours, t)) return !1;
            ...
            for (var E in d) {
                ...
                if (Tt(v, S.range)) {
                    ...
                    if (m && !m(new xi(t, c[S.defId], S), new xi(t, y, h))) return !1
                }
            }
            for (var D = 0, T = g.allows; D < T.length; D++) {
                var b = T[D], w = e.eventStore.defs[y.defId], R = e.eventStore.instances[p],
                    I = Di({}, n, {range: h.range, allDay: y.allDay});
                if (!b(t.buildDateSpanApi(I), new xi(t, w, R))) return !1
            }
        }
        return !0
    }
    ...
    function vn(e, t, n, r) {
        ...
        if (r && (l = r(l)), !gn(l.constraints, u, i, e.businessHours, t)) return !1;
        ...
        for (var d in a) {
            ...
            if (Tt(u, f.range)) {
                ...
                if (c && !c(new xi(t, o[f.defId], f))) return !1
            }
        }
    ...
    function gn(e, t, n, r, i) {
        for (var o = 0, a = e; o < a.length; o++) {
            if (!En(yn(a[o], t, n, r, i), t)) return !1
        }
        return !0
    }

    function yn(e, t, n, r, i) {
        return "businessHours" === e ? mn(lt(r, t, i)) : "string" == typeof e ? mn(gt(n, function (t) {
            return t.groupId === e
        })) : "object" == typeof e && e ? mn(lt(e, t, i)) : []
    }
    ...
    function En(e, t) {
        for (var n = 0, r = e; n < r.length; n++) {
            if (bt(r[n], t)) return !0
        }
        return !1
    }

    function Sn(e, t) {
        return Array.isArray(e) ? st(e, "", t, !0) : "object" == typeof e && e ? st([e], "", t, !0) : null != e ? String(e) : null
    }
    ...
    function Rn(e, t, n) {
        var r = Ge(e, Hi, {}, n), i = Sn(r.constraint, t);
        return {
    ...
    function kn(e, t, n, r) {
        var i = Nn(t, n), o = {}, a = $e(e, i, n.dateEnv, n.pluginSystem.hooks.recurringTypes, o);
        if (a) {
            var s = On(o, t, a.allDay, Boolean(a.duration), n);
            return s.recurringDef = {typeId: a.typeId, typeData: a.typeData, duration: a.duration}, {
                def: s,
                instance: null
            }
        }
        var u = {}, l = Pn(e, i, n, u, r);
        if (l) {
            var s = On(u, t, l.allDay, l.hasEnd, n);
            return {def: s, instance: _n(s.defId, l.range, l.forcedStartTzo, l.forcedEndTzo)}
        }
        return null
    }
    ...
    function On(e, t, n, r, i) {
        var o = {}, a = Hn(e, i, o);
        a.defId = String(Li++), a.sourceId = t, a.allDay = n, a.hasEnd = r;
        for (var s = 0, u = i.pluginSystem.hooks.eventDefParsers; s < u.length; s++) {
            var l = u[s], c = {};
            l(a, o, c), o = c
        }
        return a.extendedProps = Di(o, a.extendedProps || {}), Object.freeze(a.ui.classNames), Object.freeze(a.extendedProps), a
    }

    function _n(e, t, n, r) {
        return {
            instanceId: String(Li++),
            defId: e,
            range: t,
    ...
    function Pn(e, t, n, r, i) {
        var o, a, s = xn(e, r), u = s.allDay, l = null, c = !1, d = null;
    ...
    function Ln(e, t, n) {
        ...
        function i() {
            a && Ct(a, arguments) || (r(), o = this, a = arguments, e.apply(this, arguments))
        }
    ...
    function An(e, t, n, r) {
        ...
        return t instanceof Date ? i = t : (i = t.date, o = t.type, a = t.forceOff), s = {
            date: u.formatIso(i, {omitTime: !0}),
            type: o || "day"
        }, "string" == typeof n && (r = n, n = null), n = n ? " " + bn(n) : "", r = r || "", !a && e.opt("navLinks") ? "<a" + n + ' data-goto="' + Dn(JSON.stringify(s)) + '">' + r + "</a>" : "<span" + n + ">" + r + "</span>"
    }
    ...
    function Fn(e, t, n, r) {
        var i, o, a = n.calendar, s = n.view, u = n.theme, l = n.dateEnv, c = [];
        return wt(t.activeRange, e) ? (c.push("fc-" + yi[e.getUTCDay()]), s.opt("monthMode") && l.getMonth(e) !== l.getMonth(t.currentRange.start) && c.push("fc-other-month"), i = X(a.getNow()), o = V(i, 1), e < i ? c.push("fc-past") : e >= o ? c.push("fc-future") : (c.push("fc-today"), !0 !== r && c.push(u.getClass("today")))) : c.push("fc-disabled-day"), c
    }
    ...
    function Gn(e, t) {
        return {
            ...
            themeClasses: Di({}, e.themeClasses, t.themeClasses),
    ...
    function Qn(e, t, n) {
        ...
        return r = e.startParam, null == r && (r = n.opt("startParam")), i = e.endParam, null == i && (i = n.opt("endParam")), o = e.timeZoneParam, null == o && (o = n.opt("timeZoneParam")), a = "function" == typeof e.extraParams ? e.extraParams() : e.extraParams || {}, Di(u, a), u[r] = s.formatIso(t.start), u[i] = s.formatIso(t.end), "local" !== s.timeZone && (u[o] = s.timeZone), u
    }
    ...
    function nr(e) {
        for (var t = window.FullCalendarLocalesAll || [], n = window.FullCalendarLocales || {}, r = [], i = 0, o = e; i < o.length; i++) {
            var a = o[i];
            "string" == typeof a ? n[a] ? r.push(n[a]) : console.warn("You must have " + a + ".js locale file loaded.") : r.push(a)
        }
        for (var s = r.length ? r[0].code : "en", u = {en: vo}, l = 0, c = r.concat(t); l < c.length; l++) {
            var d = c[l];
            u[d.code] = d
        }
        return {map: u, defaultCode: s}
    }

    function rr(e, t) {
        return "object" != typeof e || Array.isArray(e) ? ir(e, t) : ar(e.code, [e.code], e)
    }

    function ir(e, t) {
        var n = [].concat(e || []);
        return ar(e, n, or(n, t) || vo)
    }
    ...
    function ur(e) {
        var t = null, n = !1, r = Eo.exec(e);
        r && (n = !r[1], n ? e += "T00:00:00Z" : e = e.replace(So, function (e, n, r, i, o) {
            return t = n ? 0 : (60 * parseInt(i, 10) + parseInt(o || 0, 10)) * ("-" === r ? -1 : 1), ""
        }) + "Z");
        var i = new Date(e);
        return ae(i) ? {marker: i, isTimeUnspecified: n, timeZoneOffset: t} : null
    }
    ...
    function cr(e, t) {
        for (var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1; r >= 0; r--) {
            var i = n[r], o = i.parseMeta(e);
            if (o) return dr("object" == typeof e ? e : {}, o, r, t)
        }
        return null
    }

    function dr(e, t, n, r) {
        var i = {}, o = Ge(e, To, {}, i), a = {}, s = Rn(i, r, a);
        return o.isFetching = !1, o.latestFetchId = "", o.fetchRange = null, o.publicId = String(e.id || ""), o.sourceId = String(bo++), o.sourceDefId = n, o.meta = t, o.ui = s, o.extendedProps = a, o
    }

    function fr(e, t, n, r) {
        switch (t.type) {
            case"ADD_EVENT_SOURCES":
                return pr(e, t.sources, n ? n.activeRange : null, r);
            case"REMOVE_EVENT_SOURCE":
                return hr(e, t.sourceId);
            case"PREV":
            case"NEXT":
            case"SET_DATE":
            case"SET_VIEW_TYPE":
                return n ? vr(e, n.activeRange, r) : e;
            case"FETCH_EVENT_SOURCES":
            case"CHANGE_TIMEZONE":
                return yr(e, t.sourceIds ? ot(t.sourceIds) : Sr(e, r), n ? n.activeRange : null, r);
            case"RECEIVE_EVENTS":
            case"RECEIVE_EVENT_ERROR":
                return Er(e, t.sourceId, t.fetchId, t.fetchRange);
            case"REMOVE_ALL_EVENT_SOURCES":
                return {};
            default:
                return e
    ...
    function vr(e, t, n) {
        return yr(e, rt(e, function (e) {
            return gr(e, t, n)
        }), t, n)
    }

    function gr(e, t, n) {
        return lr(e, n) ? !n.opt("lazyFetching") || !e.fetchRange || t.start < e.fetchRange.start || t.end > e.fetchRange.end : !e.latestFetchId
    }
    ...
    function yr(e, t, n, r) {
        ...
        for (var o in e) {
            var a = e[o];
            t[o] ? i[o] = mr(a, n, r) : i[o] = a
        }
        return i
    }

    function mr(e, t, n) {
        var r = n.pluginSystem.hooks.eventSourceDefs[e.sourceDefId], i = String(wo++);
        ...
        }), Di({}, e, {isFetching: !0, latestFetchId: i})
    }

    function Er(e, t, n, r) {
        var i, o = e[t];
        return o && n === o.latestFetchId ? Di({}, e, (i = {}, i[t] = Di({}, o, {
            isFetching: !1,
            fetchRange: r
        }), i)) : e
    }
    ...
    function Tr(e, t, n) {
        for (var r = br(e.viewType, t), i = wr(e.dateProfile, t, e.currentDate, r, n), o = fr(e.eventSources, t, i, n), a = Di({}, e, {
            viewType: r,
            dateProfile: i,
            currentDate: Rr(e.currentDate, t, i),
            eventSources: o,
            eventStore: nn(e.eventStore, t, o, i, n),
            dateSelection: Ir(e.dateSelection, t, n),
            eventSelection: Cr(e.eventSelection, t),
            eventDrag: Mr(e.eventDrag, t, o, n),
            eventResize: kr(e.eventResize, t, o, n),
            eventSourceLoadingLevel: Or(o),
            loadingLevel: Or(o)
    ...
    function wr(e, t, n, r, i) {
        ...
        switch (t.type) {
            ...
            case"NEXT":
                ...
                break;
            case"SET_DATE":
                e.activeRange && wt(e.currentRange, t.dateMarker) || (o = i.dateProfileGenerators[r].build(t.dateMarker, void 0, !0));
                break;
            case"SET_VIEW_TYPE":
        ...
        return !o || !o.isValid || e && Dr(e, o) ? e : o
    }
    ...
    function Rr(e, t, n) {
        switch (t.type) {
            case"PREV":
            case"NEXT":
                return wt(n.currentRange, e) ? e : n.currentRange.start;
            case"SET_DATE":
            case"SET_VIEW_TYPE":
                var r = t.dateMarker || e;
                return n.activeRange && !wt(n.activeRange, r) ? n.currentRange.start : r;
            default:
                return e
        }
    }
    ...
    function Pr(e, t) {
        var n = {}, r = Ge(e, Io, {}, n), i = r.start ? t.createMarkerMeta(r.start) : null,
    ...
    function xr(e, t) {
        return Dt(e.range, t.range) && e.allDay === t.allDay && Hr(e, t)
    }
    ...
    function Ur(e, t, n) {
        var r = On({editable: !1}, "", e.allDay, !0, n);
        return {def: r, ui: Kt(r, t), instance: _n(r.defId, e.range), range: e.range, isStart: !0, isEnd: !0}
    }

    function Lr(e, t) {
        var n, r = {};
        for (n in e) Vr(n, r, e, t);
        for (n in t) Vr(n, r, e, t);
        return r
    }
    ...
    function Ar(e, t, n, r) {
        ...
        !u && s && (u = Br(s, r) || Br(s, n));
        var l = u ? Vr(u, t, n, r) : null;
        return !s && l && (s = l.class), s ? {
            type: e,
            class: s,
            defaults: Di({}, l ? l.defaults : {}, i ? i.options : {}),
            overrides: Di({}, l ? l.overrides : {}, o ? o.options : {})
        } : null
    }
    ...
    function jr(e, t, n) {
        ...
        return {
            ...
            durationUnit: o,
            singleUnit: a,
            options: Di({}, co, e.defaults, n.dirDefaults, n.localeDefaults, n.overrides, s, e.overrides, n.dynamicOverrides),
            buttonTextOverride: l(n.dynamicOverrides) || l(n.overrides) || e.overrides.buttonText,
            buttonTextDefault: l(n.localeDefaults) || l(n.dirDefaults) || e.defaults.buttonText || l(co) || e.type
        }
    }

    function Yr(e, t) {
        var n;
        return n = /^(year|month)$/.test(e.currentRangeUnit) ? e.currentRange : e.activeRange, this.dateEnv.formatRange(n.start, n.end, Vt(t.titleFormat || qr(e), t.titleRangeSeparator), {isEndExclusive: e.isRangeAllDay})
    }
    ...
    function Qr(e) {
        return new (this.pluginSystem.hooks.themeClasses[e.themeSystem] || Ho)(e)
    }
    ...
    function ri(e, t) {
        void 0 === t && (t = {});
        var n = oi(t), r = Vt(t), i = n.createMarkerMeta(e);
        return i ? n.format(i.marker, r, {forcedTzo: i.forcedTzo}) : ""
    }

    function ii(e, t, n) {
        var r = oi("object" == typeof n && n ? n : {}), i = Vt(n, co.defaultRangeSeparator), o = r.createMarkerMeta(e),
    ...
    function oi(e) {
        var t = rr(e.locale || "en", nr([]).map);
        return e = Di({timeZone: co.timeZone, calendarSystem: "gregory"}, e, {locale: t}), new Do(e)
    }

    function ai(e) {
        var t = {}, n = Ge(e, Bo, Fo, t);
    ...
    function ui(e, t, n, r, i, o, a, s) {
        var u, l = o.view, c = o.dateEnv, d = o.theme, f = o.options, p = wt(t.activeRange, e),
            h = ["fc-day-header", d.getClass("widgetHeader")];
        return u = "function" == typeof f.columnHeaderHtml ? f.columnHeaderHtml(c.toDate(e)) : Dn("function" == typeof f.columnHeaderText ? f.columnHeaderText(c.toDate(e)) : c.format(e, i)), n ? h = h.concat(Fn(e, t, o, !0)) : h.push("fc-" + yi[e.getUTCDay()]), '<th class="' + h.join(" ") + '"' + (p && n ? ' data-date="' + c.formatIso(e, {omitTime: !0}) + '"' : "") + (a > 1 ? ' colspan="' + a + '"' : "") + (s ? " " + s : "") + ">" + (p ? An(l, {
            date: e,
            forceOff: !n || 1 === r
        }, u) : u) + "</th>"
    }
    ...
    function li(e, t) {
        var n = e.activeRange;
        return t ? n : {start: A(n.start, e.minTime.milliseconds), end: A(n.end, e.maxTime.milliseconds - 864e5)}
    }

    var ci = {className: !0, colSpan: !0, rowSpan: !0}, di = {"<tr": "tbody", "<td": "tr"},
        fi = Element.prototype.matches || Element.prototype.matchesSelector || Element.prototype.msMatchesSelector,
        pi = Element.prototype.closest || function (e) {
            var t = this;
            ...
            return null
        }, hi = /(top|left|right|bottom|width|height)$/i, vi = null,
        gi = ["webkitTransitionEnd", "otransitionend", "oTransitionEnd", "msTransitionEnd", "transitionend"],
        yi = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], mi = ["years", "months", "days", "milliseconds"],
        Ei = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/, Si = function (e, t) {
            return (Si = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (e, t) {
                e.__proto__ = t
            } || function (e, t) {
        ...
        }, Ti = {week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0},
        bi = {timeZoneName: 7, era: 6, year: 5, month: 4, day: 2, weekday: 2, hour: 1, minute: 1, second: 1},
        wi = /\s*([ap])\.?m\.?/i, Ri = /,/g, Ii = /\s+/g, Ci = /\u200e/g, Mi = /UTC|GMT/, ki = function () {
            function e(e) {
                var t = {}, n = {}, r = 0;
                for (var i in e) i in Ti ? (n[i] = e[i], r = Math.max(Ti[i], r)) : (t[i] = e[i], i in bi && (r = Math.max(bi[i], r)));
                this.standardDateProps = t, this.extendedSettings = n, this.severity = r, this.buildFormattingFunc = Mt(Ot)
            }

            return e.prototype.format = function (e, t) {
                return this.buildFormattingFunc(this.standardDateProps, this.extendedSettings, t)(e)
            }, e.prototype.formatRange = function (e, t, n) {
                var r = this, i = r.standardDateProps, o = r.extendedSettings, a = zt(e.marker, t.marker, n.calendarSystem);
                ...
                var u = this.format(e, n), l = this.format(t, n);
                if (u === l) return u;
                var c = Ut(i, s), d = Ot(c, o, n), f = d(e), p = d(t), h = Lt(u, f, l, p), v = o.separator || "";
            ...
            return e.prototype.setProp = function (e, t) {
                var n, r;
                if (e in Ui) ; else if (e in zi) "function" == typeof zi[e] && (t = zi[e](t)), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in Hi) {
                    var i = void 0;
                    "function" == typeof Hi[e] && (t = Hi[e](t)), "color" === e ? i = {
                        backgroundColor: t,
                        borderColor: t
                    } : "editable" === e ? i = {
                        startEditable: t,
                        durationEditable: t
                    } : (r = {}, r[e] = t, i = r), this.mutate({standardProps: {ui: i}})
                }
                ...
                if (r && this._instance) {
                    var i = this._instance.range, o = Qe(i.start, r, n, t.granularity), a = null;
                    if (t.maintainDuration) {
                        a = ve(Qe(i.start, i.end, n, t.granularity), Qe(r, i.end, n, t.granularity))
                    }
                    this.mutate({startDelta: o, endDelta: a})
                }
                ...
                var t = this._calendar.dateEnv, n = this._instance, r = Vt(e, this._calendar.opt("defaultRangeSeparator"));
                ...
                get: function () {
                    ...
                    return e ? new Pi(this._calendar, this._calendar.state.eventSources[e]) : null
                }, enumerable: !0, configurable: !0
            ...
            textColor: "",
            classNames: []
        }, zi = {id: String, groupId: String, title: String, url: String, rendering: String, extendedProps: null},
        Ui = {start: null, date: null, end: null, allDay: null}, Li = 0, Vi = {
            startTime: "09:00",
            endTime: "17:00",
            ...
            function e() {
                this.getKeysForEventDefs = Mt(this._getKeysForEventDefs), this.splitDateSelection = Mt(this._splitDateSpan), this.splitEventStore = Mt(this._splitEventStore), this.splitIndividualUi = Mt(this._splitIndividualUi), this.splitEventDrag = Mt(this._splitInteraction), this.splitEventResize = Mt(this._splitInteraction), this.eventUiBuilders = {}
            }
            ...
            return e.prototype.splitProps = function (e) {
                ...
                this.eventUiBuilders = it(n, function (e, n) {
                    return t.eventUiBuilders[n] || Mt(Vn)
                });
                for (var c in n) {
                    var d = n[c], f = a[c] || Ai, p = this.eventUiBuilders[c];
                    l[c] = {
                ...
                if (e) {
                    var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                        ...
                        o = function (r) {
                            t[r] || (t[r] = {
                                affectedEvents: n[r] || Ai,
                                mutatedEvents: i[r] || Ai,
                                isEvent: e.isEvent,
                                origSeg: e.origSeg
                            })
                        };
            ...
            return tt(t, e), t.prototype.on = function (e, t) {
                return Zn(this._handlers || (this._handlers = {}), e, t), this
            }, t.prototype.one = function (e, t) {
                return Zn(this._oneHandlers || (this._oneHandlers = {}), e, t), this
            }, t.prototype.off = function (e, t) {
                return this._handlers && jn(this._handlers, e, t), this._oneHandlers && jn(this._oneHandlers, e, t), this
            ...
            return e.prototype.build = function () {
                ...
                for (var t = [], n = [], r = 0, i = this.els; r < i.length; r++) {
                    var o = i[r], a = o.getBoundingClientRect();
            ...
            return tt(t, e), t.prototype.getScrollTop = function () {
            ...
            function n(n, r) {
                var i = e.call(this, t("div", {className: "fc-scroller"})) || this;
                return i.overflowX = n, i.overflowY = r, i.applyOverflow(), i
            }

            return tt(n, e), n.prototype.clear = function () {
                this.setHeight("auto"), this.applyOverflow()
            }, n.prototype.destroy = function () {
                c(this.el)
            }, n.prototype.applyOverflow = function () {
                g(this.el, {overflowX: this.overflowX, overflowY: this.overflowY})
                ...
                var e = C(this.el);
                return {
                    left: e.scrollbarLeft, right: e.scrollbarRight, bottom: e.scrollbarBottom
                }
            }, n
        }(Yi), Xi = function () {
            function e(e) {
    ...
    Xi.prototype.classes = {}, Xi.prototype.iconClasses = {}, Xi.prototype.baseIconClass = "", Xi.prototype.iconOverridePrefix = "";
    var Ji = 0, Ki = function () {
        function e(e, t) {
            t && (e.view = this), this.uid = String(Ji++), this.context = e, this.dateEnv = e.dateEnv, this.theme = e.theme, this.view = e.view, this.calendar = e.calendar, this.isRtl = "rtl" === this.opt("dir")
        }

        return e.addEqualityFuncs = function (e) {
            this.prototype.equalityFuncs = Di({}, this.prototype.equalityFuncs, e)
        }, e.prototype.opt = function (e) {
            return this.context.options[e]
        }, e.prototype.receiveProps = function (e) {
            var t = Yn(this.props || {}, e, this.equalityFuncs), n = t.anyChanges, r = t.comboProps;
            this.props = r, n && this.render(r)
        }, e.prototype.render = function (e) {
        }, e.prototype.destroy = function () {
        }, e
    }();
    Ki.prototype.equalityFuncs = {};
    var Qi = function (e) {
        function t(t, n, r) {
        ...
        return tt(t, e), t.prototype.destroy = function () {
            e.prototype.destroy.call(this), c(this.el)
        }, t.prototype.queryHit = function (e, t, n, r) {
            return null
        }, t.prototype.isInteractionValid = function (e) {
            var t = this.calendar, n = this.props.dateProfile, r = e.mutatedEvents.instances;
            if (n) for (var i in r) if (!bt(n.validRange, r[i].range)) return !1;
            return cn(e, t)
        }, t.prototype.isDateSelectionValid = function (e) {
            var t = this.props.dateProfile;
            return !(t && !bt(t.validRange, e.range)) && dn(e, this.calendar)
            ...
            if (this.hasPublicHandlers("eventPositioned")) for (var r = 0, i = e; r < i.length; r++) {
                ...
                this.publiclyTriggerAfterSizing("eventPositioned", [{
                    event: new xi(n, o.eventRange.def, o.eventRange.instance),
                    isMirror: t,
                    isStart: o.isStart,
                    isEnd: o.isEnd,
                    el: o.el,
            ...
            return !(this.props.eventDrag || this.props.eventResize || d(e, ".fc-mirror") || this.isInPopover(e))
            ...
            var t = d(e, ".fc-popover");
            return t && t !== this.el
        }, t
    }(Ki);
    Qi.prototype.fgSegSelector = ".fc-event-container > *", Qi.prototype.bgSegSelector = ".fc-bgevent:not(.fc-nonbusiness)";
    var $i = 0, eo = function () {
        function e() {
            this.hooks = {
                reducers: [],
        ...
        parseMeta: function (e) {
            ...
            var r = e.eventSource.meta, i = Qn(r, e.range, e.calendar);
            Xn(r.method, r.url, i, function (e, n) {
                t({rawEvents: e, xhr: n})
            }, function (e, t) {
                n({message: e, xhr: t})
            })
        }
    }, ao = qn({eventSourceDefs: [oo]}), so = {
        parse: function (e, t, n, r) {
            var i = r.createMarker.bind(r),
                o = {daysOfWeek: null, startTime: ue, endTime: ue, startRecur: i, endRecur: i}, a = Ge(e, o, {}, n),
                s = !1;
            ...
            var l;
            return l = !a.startTime && !a.endTime && (null == t || t), s ? {
                allDay: l,
                duration: a.startTime && a.endTime ? ve(a.endTime, a.startTime) : null,
                typeData: a
            } : null
        }, expand: function (e, t, n, r) {
            var i = St(n, {start: e.startRecur, end: e.endRecur});
            return i ? $n(e.daysOfWeek, e.startTime, i, r) : []
        }
    }, uo = qn({recurringTypes: [so]}), lo = {}, co = {
    ...
    }, po = ["header", "footer", "buttonText", "buttonIcons"], ho = [no, io, ao, uo], vo = {
        code: "en",
        week: {dow: 0, doy: 4},
        dir: "ltr",
        buttonText: {
        ...
        function e(e) {
            this.overrides = Di({}, e), this.dynamicOverrides = {}, this.compute()
        }

        return e.prototype.add = function (e, t) {
            this.dynamicOverrides[e] = t, this.compute()
        }, e.prototype.compute = function () {
            var e = Ye(this.dynamicOverrides.locales, this.overrides.locales, co.locales),
                t = Ye(this.dynamicOverrides.locale, this.overrides.locale, co.locale), n = nr(e),
                r = rr(t || n.defaultCode, n.map).options, i = Ye(this.dynamicOverrides.dir, this.overrides.dir, r.dir),
                o = "rtl" === i ? fo : {};
            this.dirDefaults = o, this.localeDefaults = r, this.computed = er([co, o, r, this.overrides, this.dynamicOverrides])
        }, e
    }(), yo = {}, mo = function () {
        function e() {
        }
    ...
    var Eo = /^\s*\d{4}-\d\d-\d\d([T ]\d)?/, So = /(?:(Z)|([-+])(\d\d)(?::(\d\d))?)$/, Do = function () {
            function e(e) {
            ...
            return e.prototype.createMarker = function (e) {
                ...
                return null !== n ? {unit: "year", value: n} : null !== (n = this.diffWholeMonths(e, t)) ? {
                    unit: "month",
                    value: n
                } : null !== (n = q(e, t)) ? {unit: "week", value: n} : null !== (n = G(e, t)) ? {
                    unit: "day",
                    value: n
                } : (n = W(e, t), Ze(n) ? {unit: "hour", value: n} : (n = Z(e, t), Ze(n) ? {
                    unit: "minute",
                    value: n
                } : (n = j(e, t), Ze(n) ? {unit: "second", value: n} : {
                    unit: "millisecond",
                ...
                return void 0 === r && (r = {}), r.isEndExclusive && (t = A(t, -1)), n.formatRange({
                    marker: e,
        ...
        }(), To = {id: String, allDayDefault: Boolean, eventDataTransform: Function, success: Function, failure: Function},
        bo = 0, wo = 0, Ro = function () {
            function e(e, t) {
            ...
            return e.prototype.buildPrev = function (e, t) {
                var n = this.dateEnv, r = n.subtract(t, e.dateIncrement);
                return this.build(r, -1)
            }, e.prototype.buildNext = function (e, t) {
                var n = this.dateEnv, r = n.add(t, e.dateIncrement);
                return this.build(r, 1)
            }, e.prototype.build = function (e, t, n) {
                void 0 === n && (n = !1);
                var r, i, o, a, s, u, l = null, c = null;
                return r = this.buildValidRange(), r = this.trimHiddenDays(r), n && (e = Rt(e, r)), i = this.buildCurrentRangeInfo(e, t), o = /^(year|month|week|day)$/.test(i.unit), a = this.buildRenderRange(this.trimHiddenDays(i.range), i.unit, o), a = this.trimHiddenDays(a), s = a, this.options.showNonCurrentDates || (s = St(s, i.range)), l = ue(this.options.minTime), c = ue(this.options.maxTime), s = this.adjustActiveRange(s, l, c), s = St(s, r), u = Tt(i.range, r), {
                    validRange: r,
                ...
                var n, r = this, i = r.viewSpec, o = r.dateEnv, a = null, s = null, u = null;
                ...
                function i() {
                    s = c.startOf(e, d), u = c.add(s, n), l = {start: s, end: u}
                }

                var o, a, s, u, l, c = this.dateEnv, d = this.options.dateAlignment;
                ...
                return n ? ue(n) : (t = this.options.dateAlignment) ? ue(1, t) : e || ue({days: 1})
            }, e.prototype.getRangeOption = function (e) {
                for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                var r = this.options[e];
                return "function" == typeof r && (r = r.apply(null, t)), r && (r = yt(r, this.dateEnv)), r && (r = Je(r)), r
        ...
        }(), Io = {start: null, end: null, allDay: Boolean}, Co = {type: String, class: null}, Mo = function (e) {
            function r(n, r) {
            ...
            return tt(r, e), r.prototype.destroy = function () {
                ...
                var i = this, o = this, s = o.theme, u = o.calendar, l = u.optionsManager, c = u.viewSpecs,
                    d = t("div", {className: "fc-" + e}), f = l.computed.customButtons || {},
            ...
            function n(n, r) {
                var i = e.call(this, n) || this;
                i._renderToolbars = Ln(i.renderToolbars), i.buildViewPropTransformers = Mt(Gr), i.el = r, s(r, i.contentEl = t("div", {className: "fc-view-container"}));
                for (var o = i.calendar, a = 0, u = o.pluginSystem.hooks.viewContainerModifiers; a < u.length; a++) {
                    (0, u[a])(i.contentEl, o)
                }
                return i.toggleElClassNames(!0), i.computeTitle = Mt(Yr), i.parseBusinessHours = Mt(function (e) {
                    return zn(e, i.calendar)
                }), i
            }

            return tt(n, e), n.prototype.destroy = function () {
                ...
                var t = this.el.classList, n = "fc-" + this.opt("dir"), r = this.theme.getClass("widget");
                ...
                var o = this.opt("header"), u = this.opt("footer"), l = this.calendar.getNow(), c = r.build(l),
                    d = r.buildPrev(t, n), f = r.buildNext(t, n), p = {
                        title: i,
                        activeButton: e.type,
                        isTodayEnabled: c.isValid && !wt(t.currentRange, l),
                        isPrevEnabled: d.isValid,
                        isNextEnabled: f.isValid
                    };
                o ? (this.header || (this.header = new Mo(this.context, "fc-header-toolbar"), s(this.el, this.header.el)), this.header.receiveProps(Di({layout: o}, p))) : this.header && (this.header.destroy(), this.header = null), u ? (this.footer || (this.footer = new Mo(this.context, "fc-footer-toolbar"), a(this.el, this.footer.el)), this.footer.receiveProps(Di({layout: u}, p))) : this.footer && (this.footer.destroy(), this.footer = null)
            }, n.prototype.renderView = function (e, t) {
                var n = this.view, r = e.viewSpec, i = e.dateProfileGenerator;
                ...
                var e = this.calendar, t = e.opt("height"), n = e.opt("contentHeight");
                ...
                g(this.el, {height: this.el.offsetHeight, overflow: "hidden"})
            }, n.prototype.thawHeight = function () {
                g(this.el, {height: "", overflow: ""})
            }, n
        }(Ki), Oo = function () {
            function e(e) {
            ...
            function t(t) {
                ...
                n.handleSegClick = function (e, t) {
                    var r = n.component, i = Xt(t);
                    if (i && r.isValidSegDownEl(e.target)) {
                        var o = d(e.target, ".fc-has-url"), a = o ? o.querySelector("a[href]").href : "";
                        r.publiclyTrigger("eventClick", [{
                            el: t,
                            event: new xi(r.calendar, i.eventRange.def, i.eventRange.instance),
                            jsEvent: e,
                            view: r.view
            ...
            return tt(t, e), t.prototype.destroy = function () {
                ...
                var r = this.component, i = Xt(n);
                t && !r.isValidSegDownEl(t.target) || r.publiclyTrigger(e, [{
                    el: n,
                    event: new xi(this.component.calendar, i.eventRange.def, i.eventRange.instance),
                    jsEvent: t,
                    view: r.view
                }])
            }, t
    ...
    }, Ho.prototype.baseIconClass = "fc-icon", Ho.prototype.iconClasses = {
        close: "fc-icon-x",
        prev: "fc-icon-chevron-left",
        next: "fc-icon-chevron-right",
        prevYear: "fc-icon-chevrons-left",
        nextYear: "fc-icon-chevrons-right"
    }, Ho.prototype.iconOverrideOption = "buttonIcons", Ho.prototype.iconOverrideCustomButtonOption = "icon", Ho.prototype.iconOverridePrefix = "fc-icon-";
    var No = function () {
        function e(e, t) {
            var n = this;
            this.parseRawLocales = Mt(nr), this.buildLocale = Mt(rr), this.buildDateEnv = Mt(Kr), this.buildTheme = Mt(Qr), this.buildEventUiSingleBase = Mt(this._buildEventUiSingleBase), this.buildSelectionConfig = Mt(this._buildSelectionConfig), this.buildEventUiBySource = kt(ei, at), this.buildEventUiBases = Mt(ti), this.interactionsStore = {}, this.actionQueue = [], this.isReducing = !1, this.needsRerender = !1, this.needsFullRerender = !1, this.isRendering = !1, this.renderingPauseDepth = 0, this.buildDelayedRerender = Mt($r), this.afterSizingTriggers = {}, this.isViewUpdated = !1, this.isDatesUpdated = !1, this.isEventsUpdated = !1, this.el = e, this.optionsManager = new go(t || {}), this.pluginSystem = new eo;
            for (var r = tr(this.optionsManager.computed.plugins || []), i = 0, o = r; i < o.length; i++) {
                var a = o[i];
                this.pluginSystem.add(a)
            }
            this.handleOptions(this.optionsManager.computed), this.publiclyTrigger("_init"), this.hydrate(), this.calendarInteractions = this.pluginSystem.hooks.calendarInteractions.map(function (e) {
                return new e(n)
            })
        }
        ...
        return Object.defineProperty(e.prototype, "view", {
            ...
            this.component ? this.requestRerender(!0) : (this.renderableEventStore = ht(), this.bindHandlers(), this.executeRender())
        }, e.prototype.destroy = function () {
            if (this.component) {
            ...
            this.removeNavLinkListener = N(this.el, "click", "a[data-goto]", function (t, n) {
                ...
                r = r ? JSON.parse(r) : {};
                var i = e.dateEnv, o = i.createMarker(r.date), a = r.type, s = e.viewOpt("navLink" + Be(a) + "Click");
            ...
            this.renderingPauseDepth++, e(), this.renderingPauseDepth--, this.requestRerender()
            ...
            var t = this, n = t.state, r = t.component, i = n.viewType, o = this.viewSpecs[i],
            ...
            var s = this.renderableEventStore = n.eventSourceLoadingLevel && !this.opt("progressiveEventRendering") ? this.renderableEventStore : n.eventStore,
                u = this.buildEventUiSingleBase(o.options), l = this.buildEventUiBySource(n.eventSources),
                c = this.eventUiBases = this.buildEventUiBases(s.defs, u, l);
            !e && r || (r && (r.freezeHeight(), r.destroy()), r = this.component = new ko({
                calendar: this,
                view: null,
                dateEnv: this.dateEnv,
                theme: this.theme,
                options: this.optionsManager.computed
            }, this.el)), r.receiveProps(Di({}, n, {
                viewSpec: o,
            ...
            var n = this, r = this.dateEnv;
            this.optionsManager.add(e, t), this.handleOptions(this.optionsManager.computed), "height" === e || "contentHeight" === e || "aspectRatio" === e ? this.updateSize() : "defaultDate" === e || "defaultView" === e || /^(event|select)(Overlap|Constraint|Allow)$/.test(e) || (this.needsFullRerender = !0, this.batchRendering(function () {
                "timeZone" === e && n.dispatch({
                    type: "CHANGE_TIMEZONE",
                    oldDateEnv: r
                }), n.dispatch({type: "SET_VIEW_TYPE", viewType: n.state.viewType})
            }))
            ...
            this.dateEnv = this.buildDateEnv(i, e.timeZone, n.namedTimeZonedImpl, e.firstDay, e.weekNumberCalculation, e.weekLabel, n.cmdFormatter), this.selectionConfig = this.buildSelectionConfig(e), this.viewSpecs = Zr(n.views, this.optionsManager), this.dateProfileGenerators = it(this.viewSpecs, function (e) {
            ...
            return In("select", e, this)
        }, e.prototype._buildEventUiSingleBase = function (e) {
            return e.editable && (e = Di({}, e, {eventEditable: !0})), In("event", e, this)
            ...
            var n = null;
            t && (t.start && t.end ? (this.optionsManager.add("visibleRange", t), this.handleOptions(this.optionsManager.computed)) : n = this.dateEnv.createMarker(t)), this.unselect(), this.dispatch({
                type: "SET_VIEW_TYPE",
                viewType: e,
                dateMarker: n
            })
            ...
            for (n = 0; n < t.length; n++) if ((r = this.viewSpecs[t[n]]) && r.singleUnit === e) return r
            ...
            var n = Xr(e, t), r = [Po, xo], i = r.concat(this.pluginSystem.hooks.componentInteractions),
                o = i.map(function (e) {
                    return new e(n)
                });
            this.interactionsStore[e.uid] = o, _o[e.uid] = n
        }, e.prototype.unregisterInteractiveComponent = function (e) {
            for (var t = 0, n = this.interactionsStore[e.uid]; t < n.length; t++) {
                n[t].destroy()
            }
            delete this.interactionsStore[e.uid], delete _o[e.uid]
        }, e.prototype.select = function (e, t) {
            var n;
            n = null == t ? null != e.start ? e : {start: e, end: null} : {start: e, end: t};
            var r = _r(n, this.dateEnv, ue({days: 1}));
            ...
            if (e instanceof xi) {
                ...
                return this.state.eventStore.defs[n.defId] || this.dispatch({
                    type: "ADD_EVENTS",
                    eventStore: ut({def: n, instance: r})
                }), e
            }
            var i;
            if (t instanceof Pi) i = t.internalEventSource.sourceId; else if (null != t) {
            ...
            return a ? (this.dispatch({
                type: "ADD_EVENTS",
                eventStore: ut(a)
            }), new xi(this, a.def, a.def.recurringDef ? null : a.instance)) : null
            ...
            for (var i in n) {
                var o = n[i];
                if (o.publicId === e) {
                    if (o.recurringDef) return new xi(this, o, null);
                    for (var a in r) {
                        var s = r[a];
                        if (s.defId === o.defId) return new xi(this, o, s)
                    }
                }
            }
            return null
            ...
            for (var n in e) t.push(new Pi(this, e[n]));
            return t
        }, e.prototype.getEventSourceById = function (e) {
            var t = this.state.eventSources;
            e = String(e);
            for (var n in t) if (t[n].publicId === e) return new Pi(this, t[n]);
            return null
        }, e.prototype.addEventSource = function (e) {
            if (e instanceof Pi) return this.state.eventSources[e.internalEventSource.sourceId] || this.dispatch({
                type: "ADD_EVENT_SOURCES",
                sources: [e.internalEventSource]
            }), e;
            var t = cr(e, this);
            return t ? (this.dispatch({type: "ADD_EVENT_SOURCES", sources: [t]}), new Pi(this, t)) : null
    ...
    var zo = function (e) {
        ...
        return tt(n, e), n.prototype.initialize = function () {
            ...
            var n = this.props;
            return jt(e, n.eventUiBases, n.dateProfile.activeRange, t ? this.nextDayThreshold : null).fg
            ...
            var t, n, r, i = this, o = this.dateEnv;
            ...
            this.props.dateProfile && this.initialNowDate && (this.unrenderNowIndicator(), this.renderNowIndicator(A(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)), this.isNowIndicatorRendered = !0)
            ...
            var e = {};
            return this.props.dateProfile && Di(e, this.queryDateScroll()), e
        }, n.prototype.applyScroll = function (e, t) {
            e.isDateInit && (delete e.isDateInit, this.props.dateProfile && Di(e, this.computeInitialDateScroll())), this.props.dateProfile && this.applyDateScroll(e)
    ...
    Wi.mixInto(zo), zo.prototype.usesMinMaxTime = !1, zo.prototype.dateProfileGeneratorClass = Ro;
    var Uo = function () {
        function e(e) {
        ...
        return e.prototype.renderSegs = function (e, t) {
            ...
            if (e.length) {
                ...
                r(i).forEach(function (t, n) {
                    var r = e[n];
                    t && (r.el = t)
                }), e = qt(this.context.view, e, Boolean(t))
            }
            return e
            ...
            var t = this.context.view.eventOrderSpecs, n = e.map(ni);
        ...
        return e.prototype.getSegsByType = function (e) {
            ...
            var n, r = this.renderSegEls(e, t), i = this.attachSegs(e, r);
            ...
            if (t.length) {
                ...
                r(o).forEach(function (e, n) {
                    var r = t[n];
                    e && (r.el = e)
                }), "bgEvent" === e && (t = qt(this.context.view, t, !1)), t = t.filter(function (e) {
            ...
            var n = null, r = [];
            return "highlight" !== e && "businessHours" !== e && (n = {"background-color": t.eventRange.ui.backgroundColor}), "highlight" !== e && (r = r.concat(t.eventRange.ui.classNames)), "businessHours" === e ? r.push("fc-bgevent") : r.push("fc-" + e.toLowerCase()), "<" + this.fillSegTag + (r.length ? ' class="' + r.join(" ") + '"' : "") + (n ? ' style="' + Tn(n) + '"' : "") + "></" + this.fillSegTag + ">"
    ...
    }(), Bo = {startTime: ue, duration: ue, create: Boolean, sourceId: String}, Fo = {create: !0}, Wo = function (e) {
        function t(t, r) {
        ...
        return tt(t, e), t.prototype.destroy = function () {
            ...
            var t = e.dates, n = e.datesRepDistinctDays, r = [];
            e.renderIntroHtml && r.push(e.renderIntroHtml());
            for (var i = Vt(this.opt("columnHeaderFormat") || si(n, t.length)), o = 0, a = t; o < a.length; o++) {
                var s = a[o];
                r.push(ui(s, e.dateProfile, n, t.length, i, this.context))
            }
        ...
        return e.prototype.sliceRange = function (e) {
            var t = this.getDateDayIndex(e.start), n = this.getDateDayIndex(V(e.end, -1)), r = Math.max(0, t),
            ...
            var t = this.indices, n = Math.floor(F(this.dates[0], e));
        ...
        function e() {
            this.sliceBusinessHours = Mt(this._sliceBusinessHours), this.sliceDateSelection = Mt(this._sliceDateSpan), this.sliceEventStore = Mt(this._sliceEventStore), this.sliceEventDrag = Mt(this._sliceInteraction), this.sliceEventResize = Mt(this._sliceInteraction)
        }
        ...
        return e.prototype.sliceProps = function (e, t, n, r) {
            ...
            return this._sliceDateSpan.apply(this, [{range: {start: e, end: A(e, 1)}, allDay: !1}, {}, t].concat(n))
        }, e.prototype._sliceBusinessHours = function (e, t, n, r) {
            for (var i = [], o = 4; o < arguments.length; o++) i[o - 4] = arguments[o];
            return e ? this._sliceEventStore.apply(this, [lt(e, li(t, Boolean(n)), r.calendar), {}, t, n, r].concat(i)).bg : []
        }, e.prototype._sliceEventStore = function (e, t, n, r, i) {
            for (var o = [], a = 5; a < arguments.length; a++) o[a - 5] = arguments[a];
            if (e) {
                var s = jt(e, t, li(n, Boolean(r)), r);
            ...
            for (var o = [], a = 5; a < arguments.length; a++) o[a - 5] = arguments[a];
            if (!e) return null;
            var s = jt(e.mutatedEvents, t, li(n, Boolean(r)), r);
            return {
            ...
            if (!e) return [];
            for (var o = Ur(e, t, n.calendar), a = this.sliceRange.apply(this, [e.range].concat(r)), s = 0, u = a; s < u.length; s++) {
                var l = u[s];
