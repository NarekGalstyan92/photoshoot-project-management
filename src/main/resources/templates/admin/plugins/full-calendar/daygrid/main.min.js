!function (e, t) {
    ...
    function o(e, r, n, i) {
        var o = n.dateEnv, s = n.theme, l = t.rangeContainsMarker(r.activeRange, e), a = t.getDayClasses(e, r, n);
        return a.unshift("fc-day", s.getClass("widgetContent")), '<td class="' + a.join(" ") + '"' + (l ? ' data-date="' + o.formatIso(e, {omitTime: !0}) + '"' : "") + (i ? " " + i : "") + "></td>"
    }
    ...
    var l = function (e, t) {
        ...
        return r(n, e), n.prototype.buildRenderRange = function (r, n, i) {
            var o, s = this.dateEnv, l = e.prototype.buildRenderRange.call(this, r, n, i), a = l.start, d = l.end;
    ...
    }(t.DateProfileGenerator), c = function () {
        function e(e) {
            var t = this;
        ...
        return e.prototype.show = function () {
            ...
            var e = this, r = this.options, n = this.el = t.createElement("div", {
            ...
            var e, r, n = this.options, i = this.el, o = i.getBoundingClientRect(), s = t.computeRect(i.offsetParent),
        ...
        return r(n, e), n.prototype.renderSegHtml = function (e, r) {
            var n, i, o = this.context.options, s = e.eventRange, l = s.def, a = s.ui, d = l.allDay,
                c = a.startEditable, h = d && e.isStart && a.durationEditable && o.eventResizableFromStart,
                p = d && e.isEnd && a.durationEditable, u = this.getSegClasses(e, c, h || p, r),
                f = t.cssToStr(this.getSkinCss(a)), g = "";
    ...
    }(t.FgEventRenderer), p = function (e) {
        function o(t) {
        ...
        return r(o, e), o.prototype.attachSegs = function (e, t) {
            ...
            var i, o, s, l, a, d, c, h = this.dayGrid, p = h.colCnt, u = h.isRtl, f = this.buildSegLevels(r),
                g = Math.max(1, f.length), m = document.createElement("tbody"), y = [], v = [], b = [];
            for (i = 0; i < g; i++) {
                if (o = f[i], s = 0, l = document.createElement("tr"), y.push([]), v.push([]), b.push([]), o) for (a = 0; a < o.length; a++) {
                    d = o[a];
                    var w = u ? p - 1 - d.lastCol : d.firstCol, S = u ? p - 1 - d.firstCol : d.lastCol;
                    for (n(w), c = t.createElement("td", {className: "fc-event-container"}, d.el), w !== S ? c.colSpan = S - w + 1 : b[i][s] = c; s <= S;) v[i][s] = c, y[i][s] = d, s++;
                    l.appendChild(c)
                }
                n(p);
            ...
            return {row: e, tbodyEl: m, cellMatrix: v, segMatrix: y, segLevels: f, segs: r}
        }, o.prototype.buildSegLevels = function (e) {
            var t, r, o, s = this.dayGrid, l = s.isRtl, a = s.colCnt, d = [];
        ...
        return r(n, e), n.prototype.attachSegs = function (e, r) {
            var n = r.sourceSeg, i = this.rowStructs = this.renderSegRows(e);
        ...
        return r(n, e), n.prototype.renderSegs = function (t, r) {
            ...
            var n, i, o, s = this.dayGrid, l = s.colCnt, a = s.isRtl, d = a ? l - 1 - r.lastCol : r.firstCol,
                c = a ? l - 1 - r.firstCol : r.lastCol, h = d, p = c + 1;
    ...
    }(t.FillRenderer), g = function (e) {
        function n(r, n) {
            var i = e.call(this, r, n) || this, o = i.eventRenderer = new m(i),
        ...
        return r(n, e), n.prototype.render = function (e) {
            ...
            var r = this, n = r.theme, i = r.dateEnv, o = i.format(e, t.createFormatter(this.opt("dayPopoverFormat")));
            ...
            if (e < n && r < i) return {
                component: this,
                dateSpan: {allDay: !0, range: {start: o, end: t.addDays(o, 1)}},
                dayEl: this.el,
                rect: {left: 0, top: 0, right: n, bottom: i},
                layer: 1
            }
        }, n
    }(t.DateComponent), m = function (e) {
        function n(t) {
            var r = e.call(this, t.context) || this;
    ...
    }(), v = t.createFormatter({day: "numeric"}), b = t.createFormatter({week: "numeric"}), w = function (e) {
        function n(r, n, i) {
            var o = e.call(this, r, n) || this;
            o.bottomCoordPadding = 0, o.isCellSizesDirty = !1;
            var s = o.eventRenderer = new p(o), l = o.fillRenderer = new f(o);
        ...
        return r(n, e), n.prototype.render = function (e) {
            ...
            return {start: n, end: t.addDays(n, 1)}
            ...
            var n, i, o = this, s = o.view, l = o.dateEnv, a = this, d = a.rowCnt, c = a.colCnt, h = "";
            ...
            var r = this.theme, n = ["fc-row", "fc-week", r.getClass("dayRow")];
            t && n.push("fc-rigid");
            ...
            var r, n, i = this, o = i.view, s = i.dateEnv, l = "",
                a = t.rangeContainsMarker(this.props.dateProfile.activeRange, e),
                d = this.getIsDayNumbersVisible() && a;
            return d || this.renderProps.cellWeekNumbersVisible ? (r = t.getDayClasses(e, this.props.dateProfile, this.context), r.unshift("fc-day-top"), this.renderProps.cellWeekNumbersVisible && (n = s.weekDow), l += '<td class="' + r.join(" ") + '"' + (a ? ' data-date="' + s.formatIso(e, {omitTime: !0}) + '"' : "") + ">", this.renderProps.cellWeekNumbersVisible && e.getUTCDay() === n && (l += t.buildGotoAnchorHtml(o, {
                date: e,
                type: "week"
            }, {class: "fc-week-number"}, s.format(e, b))), d && (l += t.buildGotoAnchorHtml(o, e, {class: "fc-day-number"}, s.format(e, v))), l += "</td>") : "<td></td>"
        }, n.prototype.updateSize = function (e) {
            var t = this, r = t.fillRenderer, n = t.eventRenderer, i = t.mirrorRenderer;
            ...
            var r = this, n = r.colPositions, i = r.rowPositions, o = n.leftToIndex(e), s = i.topToIndex(t);
            if (null != s && null != o) return {
                row: s,
                col: o,
                dateSpan: {range: this.getCellRange(s, o), allDay: !0},
                dayEl: this.getCellEl(s, o),
                relativeRect: {left: n.lefts[o], right: n.rights[o], top: i.tops[s], bottom: i.bottoms[s]}
            }
            ...
            var r, n, i = this.rowEls[e], o = i.getBoundingClientRect().bottom,
            ...
            var n, i, o, s, l, a, d, c, h, p, u, f, g, m, y, v = this, b = this, w = b.colCnt, S = b.isRtl,
                C = this.eventRenderer.rowStructs[e], E = [], R = 0, H = function (n) {
            ...
            if (r && r < C.segLevels.length) {
                for (n = C.segLevels[r - 1], i = C.cellMatrix, o = t.findChildren(C.tbodyEl).slice(r), o.forEach(function (e) {
                    ...
                    l = n[s];
                    var D = S ? w - 1 - l.lastCol : l.firstCol, P = S ? w - 1 - l.firstCol : l.lastCol;
            ...
            var i = this, o = this, s = o.view, l = o.dateEnv, a = t.createElement("a", {className: "fc-more"});
            return a.innerText = this.getMoreLinkText(n.length), a.addEventListener("click", function (t) {
                var o = i.opt("eventLimitClick"), a = i.isRtl ? i.colCnt - r - 1 : r, d = i.props.cells[e][a].date,
                    c = t.currentTarget, h = i.getCellEl(e, r), p = i.getCellSegs(e, r), u = i.resliceDaySegs(p, d),
            ...
            var o, s, l = this, a = this, d = a.calendar, h = a.view, p = a.theme,
                u = this.isRtl ? this.colCnt - r - 1 : r, f = n.parentNode;
            ...
            for (var n = r, i = t.addDays(n, 1), o = {start: n, end: i}, s = [], l = 0, d = e; l < d.length; l++) {
                var c = d[l], h = c.eventRange, p = h.range, u = t.intersectRanges(p, o);
                u && s.push(a({}, c, {
                    eventRange: {
                        def: h.def,
                        ui: a({}, h.ui, {durationEditable: !1}),
                        instance: h.instance,
                        range: u
                    },
    ...
    }(t.DateComponent), S = t.createFormatter({week: "numeric"}), C = function (e) {
        function n(r, n, i, o) {
            ...
            s.renderHeadIntroHtml = function () {
                ...
                var n = s.dateEnv, i = r.props.cells[e][0].date;
            ...
            var a = t.createElement("div", {className: "fc-day-grid"});
            l.appendChild(a);
            var d;
        ...
        return r(n, e), n.prototype.destroy = function () {
            ...
            var i, o, s = this.dayGrid, l = this.opt("eventLimit"), a = this.header ? this.header.el : null;
    ...
    var E = function (e) {
        function t(t, r) {
            ...
            return n.slicer = new R, n.dayGrid = r, t.calendar.registerInteractiveComponent(n, {el: n.dayGrid.el}), n
        }
        ...
        return r(t, e), t.prototype.destroy = function () {
            ...
            var t = this.dayGrid, r = e.dateProfile, n = e.dayTable;
        ...
        return r(n, e), n.prototype.destroy = function () {
            ...
            var r = this.props.dateProfile, n = this.dayTable = this.buildDayTable(r, this.dateProfileGenerator);
    ...
    e.default = D, e.SimpleDayGrid = E, e.DayGridSlicer = R, e.DayGrid = w, e.AbstractDayGridView = C, e.DayGridView = H, e.buildBasicDayTable = s, e.DayBgRow = y, Object.defineProperty(e, "__esModule", {value: !0})
});