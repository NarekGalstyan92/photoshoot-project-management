!function (e, t) {
    ...
    function o() {
        D++ || window.addEventListener("touchmove", l, {passive: !1})
    }

    function a() {
        --D || window.removeEventListener("touchmove", l, {passive: !1})
    }
    ...
    function u(e, n, r) {
        var i = e.dateSpan, o = n.dateSpan, a = [i.range.start, i.range.end, o.range.start, o.range.end];
        ...
        return l.range = {start: a[0], end: a[3]}, l.allDay = i.allDay, l
    }

    function g(e, n, r) {
        var i = e.dateSpan, o = n.dateSpan, a = i.range.start, l = o.range.start, s = {};
        ...
        for (var d = {startDelta: c, endDelta: c, standardProps: s}, u = 0, g = r; u < g.length; u++) {
            (0, g[u])(d, e, n)
        }
        return d
    }
    ...
    function v(e, n, r) {
        ...
        var s = t.parseEventDef(i, n.sourceId, e.allDay, Boolean(n.duration), r), c = e.range.start;
        ...
        return {def: s, instance: t.createEventInstance(s.defId, {start: c, end: d})}
    }

    function f(e) {
        var n = E(e, "event"), r = n ? JSON.parse(n) : {create: !1};
        return t.parseDragMeta(r)
    }

    function E(e, n) {
        var r = t.config.dataAttrPrefix, i = (r ? r + "-" : "") + n;
