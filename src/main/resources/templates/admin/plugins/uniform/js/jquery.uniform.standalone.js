!function (e, t, n) {
    ...
    var H = !0, A = !1, W = [{
        ...
        match: function (e) {
            ...
            var n, s, u;
            return n = d(e, t, {divClass: t.checkboxClass}), s = n.div, u = n.span, i(e, s, t), a(e, t, {
                "click touchend": function () {
                    l(u, e, t)
                }
            }), l(u, e, t), {
                remove: x(e, t), update: function () {
        ...
        match: function (e) {
            ...
            var u, c, f;
            return u = d(e, n, {divClass: n.radioClass}), c = u.div, f = u.span, i(e, c, n), a(e, n, {
                "click touchend": function () {
                    void 0 != e.attr("name") ? t.uniform.update(t(':radio[name="' + s(e, "name") + '"]')) : t.uniform.update(e)
                }
            }), l(f, e, n), {
                remove: x(e, n), update: function () {
        ...
        match: function (e) {
            ...
            return n.selectAutoWidth && k(e, function () {
                ...
                g(t([l[0], u[0]]), {display: "block"}, function () {
                    var e;
