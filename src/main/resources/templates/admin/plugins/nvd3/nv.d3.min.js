!function () {
    ...
    a.dev = !1, a.tooltip = a.tooltip || {}, a.utils = a.utils || {}, a.models = a.models || {}, a.charts = {}, a.logs = {}, a.dom = {}, a.dispatch = d3.dispatch("render_start", "render_end"), Function.prototype.bind || (Function.prototype.bind = function (a) {
            ...
            l.each(function (l) {
                function m() {
                    ...
                    g.elementMousemove({
                        ...
                        mouseY: e,
                        pointXValue: l
                    }), "mouseup" === d3.event.type && g.elementMouseUp({mouseX: d, mouseY: e, pointXValue: l})
                }
        ...
        var c = {left: 0, top: 0}, d = null, e = null, f = d3.scale.linear(),
            ...
            h = !0, i = null, j = a.models.tooltip(), k = "ActiveXObject" in window;
        ...
        var d = "nvtooltip-" + Math.floor(1e5 * Math.random()), e = null, f = "w", g = 25, h = 0, i = null, j = null,
            k = !0, l = 200, m = null, n = {left: null, top: null}, o = !0, p = 100, q = !0,
            r = "nv-pointer-events-none", s = function () {
                ...
                var b, c, d, e = m.node().offsetHeight, h = m.node().offsetWidth, i = document.documentElement.clientWidth,
                ...
                a.dom.read(function () {
                    ...
                    if (k) m.interrupt().transition().delay(l).duration(0).style("opacity", 0); else {
                        var e = "translate(" + n.left + "px, " + n.top + "px)", f = "translate(" + c + "px, " + d + "px)",
                            g = d3.interpolateString(e, f), h = m.style("opacity") < .1;
        ...
        var d = Object.getOwnPropertyNames(c._options || {}), e = Object.getOwnPropertyNames(c._calls || {}),
            f = c._inherited || [], g = c._d3options || [], h = d.concat(e).concat(f).concat(g);
        ...
        var d = b.options(), e = d.margin(), f = d.noData(), g = null == f ? ["No Data Available."] : [f],
            h = a.utils.availableHeight(null, c, e), i = a.utils.availableWidth(null, c, e), j = e.left + i / 2,
            k = e.top + h / 2;
        ...
        function b(g) {
            return s.reset(), g.each(function (b) {
                ...
                var p = g.selectAll("g.nv-wrap.nv-axis").data([b]),
                    q = p.enter().append("g").attr("class", "nvd3 nv-wrap nv-axis"), t = (q.append("g"), p.select("g"));
        ...
        var c = d3.svg.axis(), d = d3.scale.linear(), e = {top: 0, right: 0, bottom: 0, left: 0}, f = 75, g = 60,
            h = null, i = !0, j = 0, k = !0, l = !1, m = !1, n = null, o = 0, p = 250, q = d3.dispatch("renderEnd");
            ...
            return v.reset(), l.each(function (b) {
                ...
                ["low", "high"].forEach(function (a) {
                    ...
                    d3.select(this).classed("hover", !0), s.elementMouseover({
                        key: a.label,
                        value: a.label,
                        series: [{key: "Q3", value: a.values.Q3, color: a.color || q(a, b)}, {
                            key: "Q2",
                            value: a.values.Q2,
                            color: a.color || q(a, b)
                        }, {key: "Q1", value: a.values.Q1, color: a.color || q(a, b)}],
                        data: a,
                        index: b,
                        e: d3.event
                    })
        ...
        var c, d, e, f, g, h, i = {top: 0, right: 0, bottom: 0, left: 0}, j = 960, k = 500,
            l = Math.floor(1e4 * Math.random()), m = d3.scale.ordinal(), n = d3.scale.linear(), o = function (a) {
                return a.x
            }, p = function (a) {
                return a.y
            }, q = a.utils.defaultColor(), r = null,
            s = d3.dispatch("elementMouseover", "elementMouseout", "elementMousemove", "renderEnd"), t = 250, u = null,
        ...
        function b(k) {
            return t.reset(), t.models(e), l && t.models(f), m && t.models(g), k.each(function (k) {
                ...
                x.append("g").attr("class", "nv-x nv-axis"), x.append("g").attr("class", "nv-y nv-axis").append("g").attr("class", "nv-zeroLine").append("line"), x.append("g").attr("class", "nv-barsWrap"),
                    z.attr("transform", "translate(" + h.left + "," + h.top + ")"), n && z.select(".nv-y.nv-axis").attr("transform", "translate(" + t + ",0)"), e.width(t).height(u);
        ...
        var c, d, e = a.models.boxPlot(), f = a.models.axis(), g = a.models.axis(),
            h = {top: 15, right: 10, bottom: 50, left: 60}, i = null, j = null, k = a.utils.getColor(), l = !0, m = !0,
            n = !1, o = !1, p = a.models.tooltip(), q = "No Data Available.",
        ...
        function b(d) {
            return d.each(function (b, d) {
                ...
                var t = f.call(this, b, d).slice().sort(d3.descending),
                    ...
                    v = h.call(this, b, d).slice().sort(d3.descending), w = i.call(this, b, d).slice(),
                    x = j.call(this, b, d).slice(), y = k.call(this, b, d).slice(),
                    z = d3.scale.linear().domain(d3.extent(d3.merge([l, t]))).range(e ? [p, 0] : [0, p]);
                this.__chart__ || d3.scale.linear().domain([0, 1 / 0]).range(z.range());
                this.__chart__ = z;
                var A = d3.min(t), B = d3.max(t), C = t[1], D = o.selectAll("g.nv-wrap.nv-bullet").data([b]),
                    E = D.enter().append("g").attr("class", "nvd3 nv-wrap nv-bullet"), F = E.append("g"),
                    G = D.select("g");
        ...
        var c = {top: 0, right: 0, bottom: 0, left: 0}, d = "left", e = !1, f = function (a) {
            ...
            }, l = [0], m = 380, n = 30, o = null, p = null, q = a.utils.getColor(["#1f77b4"]),
        ...
        function b(d) {
            return d.each(function (e, o) {
                ...
                var s = h.call(this, e, o).slice().sort(d3.descending),
                    ...
                    w = v.enter().append("g").attr("class", "nvd3 nv-wrap nv-bulletChart"), x = w.append("g"),
                    y = v.select("g");
        ...
        var c = a.models.bullet(), d = a.models.tooltip(), e = "left", f = !1,
            g = {top: 5, right: 40, bottom: 20, left: 120}, h = function (a) {
                return a.ranges
            }, i = function (a) {
                return a.markers ? a.markers : [0]
            }, j = function (a) {
        ...
        function b(x) {
            return x.each(function (b) {
                ...
                var B = d3.select(this).selectAll("g.nv-wrap.nv-candlestickBar").data([b[0].values]),
                    C = B.enter().append("g").attr("class", "nvd3 nv-wrap nv-candlestickBar"), D = C.append("defs"),
                    E = C.append("g"), F = B.select("g");
        ...
        var c, d, e, f, g, h = {top: 0, right: 0, bottom: 0, left: 0}, i = null, j = null,
            k = Math.floor(1e4 * Math.random()), l = d3.scale.linear(), m = d3.scale.linear(), n = function (a) {
                return a.x
            }, o = function (a) {
                return a.y
            }, p = function (a) {
                ...
                return a.low
            }, t = [], u = [], v = !1, w = !0, x = a.utils.defaultColor(), y = !1,
            z = d3.dispatch("stateChange", "changeState", "renderEnd", "chartClick", "elementClick", "elementDblClick", "elementMouseover", "elementMouseout", "elementMousemove");
        ...
        function b(l) {
            return H.reset(), H.models(f), r && H.models(g), s && H.models(h), l.each(function (l) {
                ...
                var l = c(G.i, l), T = v ? "none" : "all", U = L.selectAll("g.nv-wrap.nv-cumulativeLine").data([l]),
                ...
                ba.enter().append("rect").attr("class", "nv-indexLine").attr("width", 3).attr("x", -2).attr("fill", "red").attr("fill-opacity", .5).style("pointer-events", "all").call(Q), ba.attr("transform", function (a) {
                    ...
                    if (l.filter(function (a, b) {
                        ...
                        var m = b.yScale().invert(c.mouseY),
                            o = Math.abs(b.yScale().domain()[0] - b.yScale().domain()[1]), p = .03 * o,
        ...
        var d, e, f = a.models.line(), g = a.models.axis(), h = a.models.axis(), i = a.models.legend(),
            j = a.models.legend(), k = a.interactiveGuideline(), l = a.models.tooltip(),
            m = {top: 30, right: 30, bottom: 50, left: 60}, n = a.utils.defaultColor(), o = null, p = null, q = !0,
            r = !0, s = !0, t = !1, u = !0, v = !1, w = !0, x = f.id(), y = a.utils.state(), z = null, A = null,
            B = function (a) {
                return a.average
        ...
        function b(m) {
            return y.reset(), m.each(function (b) {
                ...
                var A = c.selectAll("g.nv-wrap.nv-discretebar").data([b]),
                    B = A.enter().append("g").attr("class", "nvd3 nv-wrap nv-discretebar"), C = B.append("g");
                A.select("g");
        ...
        var c, d, e, f, g, h, i, j = {top: 0, right: 0, bottom: 0, left: 0}, k = 960, l = 500,
            m = Math.floor(1e4 * Math.random()), n = d3.scale.ordinal(), o = d3.scale.linear(), p = function (a) {
                return a.x
            }, q = function (a) {
                return a.y
            }, r = [0], s = a.utils.defaultColor(), t = !1, u = d3.format(",.2f"),
        ...
        function b(h) {
            return v.reset(), v.models(e), m && v.models(f), n && v.models(g), h.each(function (h) {
                var l = d3.select(this);
                a.utils.initSVG(l);
                var s = a.utils.availableWidth(j, l, i), v = a.utils.availableHeight(k, l, i);
                if (b.update = function () {
                    t.beforeUpdate(), l.transition().duration(u).call(b)
                }, b.container = this, !(h && h.length && h.filter(function (a) {
                    return a.values.length
                }).length)) return a.utils.noData(b, l), b;
                l.selectAll(".nv-noData").remove(), c = e.xScale(), d = e.yScale().clamp(!0);
                var w = l.selectAll("g.nv-wrap.nv-discreteBarWithAxes").data([h]),
                    x = w.enter().append("g").attr("class", "nvd3 nv-wrap nv-discreteBarWithAxes").append("g"),
                    y = x.append("defs"), z = w.select("g");
                x.append("g").attr("class", "nv-x nv-axis"), x.append("g").attr("class", "nv-y nv-axis").append("g").attr("class", "nv-zeroLine").append("line"), x.append("g").attr("class", "nv-barsWrap"), z.attr("transform", "translate(" + i.left + "," + i.top + ")"), o && z.select(".nv-y.nv-axis").attr("transform", "translate(" + s + ",0)"), e.width(s).height(v);
                var A = z.select(".nv-barsWrap").datum(h.filter(function (a) {
                    return !a.disabled
                }));
                if (A.transition().call(e), y.append("clipPath").attr("id", "nv-x-label-clip-" + e.id()).append("rect"), z.select("#nv-x-label-clip-" + e.id() + " rect").attr("width", c.rangeBand() * (p ? 2 : 1)).attr("height", 16).attr("x", -c.rangeBand() / (p ? 1 : 2)), m) {
                    f.scale(c)._ticks(a.utils.calcTicksX(s / 100, h)).tickSize(-v, 0), z.select(".nv-x.nv-axis").attr("transform", "translate(0," + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ")"), z.select(".nv-x.nv-axis").call(f);
                    var B = z.select(".nv-x.nv-axis").selectAll("g");
                    p && B.selectAll("text").attr("transform", function (a, b, c) {
                        return "translate(0," + (c % 2 == 0 ? "5" : "17") + ")"
                ...
                n && (g.scale(d)._ticks(a.utils.calcTicksY(v / 36, h)).tickSize(-s, 0), z.select(".nv-y.nv-axis").call(g)), z.select(".nv-zeroLine line").attr("x1", 0).attr("x2", s).attr("y1", d(0)).attr("y2", d(0))
            }), v.renderEnd("discreteBar chart immediate"), b
        }

        var c, d, e = a.models.discreteBar(), f = a.models.axis(), g = a.models.axis(), h = a.models.tooltip(),
            i = {top: 15, right: 10, bottom: 50, left: 60}, j = null, k = null, l = a.utils.getColor(), m = !0, n = !0,
            o = !1, p = !1, q = !1, r = 0, s = null, t = d3.dispatch("beforeUpdate", "renderEnd"), u = 250;
        f.orient("bottom").showMaxMin(!1).tickFormat(function (a) {
            return a
        ...
        return e.dispatch.on("elementMouseover.tooltip", function (a) {
            a.series = {key: b.x()(a.data), value: b.y()(a.data), color: a.color}, h.data(a).hidden(!1)
        }), e.dispatch.on("elementMouseout.tooltip", function (a) {
            h.hidden(!0)
        }), e.dispatch.on("elementMousemove.tooltip", function (a) {
            h()
        }), b.dispatch = t, b.discretebar = e, b.xAxis = f, b.yAxis = g, b.tooltip = h, b.options = a.utils.optionsFunc.bind(b), b._options = Object.create({}, {
            width: {
                get: function () {
                    return j
                }, set: function (a) {
                ...
                get: function () {
                    ...
                    u = a, v.reset(u), e.duration(u), f.duration(u), g.duration(u)
                }
            }, color: {
                get: function () {
                    return l
        ...
        function b(k) {
            return m.reset(), k.each(function (b) {
                ...
                var n = l.selectAll("g.nv-distribution").data([b]),
                    o = n.enter().append("g").attr("class", "nvd3 nv-distribution"), p = (o.append("g"), n.select("g"));
        ...
        var c, d = {top: 0, right: 0, bottom: 0, left: 0}, e = 400, f = 8, g = "x", h = function (a) {
                return a[g]
            }, i = a.utils.defaultColor(), j = d3.scale.linear(), k = 250, l = d3.dispatch("renderEnd"),
        ...
        function b(q) {
            ...
            return q.each(function (b) {
                ...
                a.utils.initSVG(t);
                var u = t.selectAll("g.nv-legend").data([b]),
                    v = (u.enter().append("g").attr("class", "nvd3 nv-legend").append("g"), u.select("g"));
        ...
        var c = {top: 5, right: 0, bottom: 5, left: 0}, d = 400, e = 20, f = function (a) {
                return a.key
            }, g = a.utils.getColor(), h = 20, i = !0, j = 28, k = !0, l = !0, m = !1, n = !1,
            o = d3.dispatch("legendClick", "legendDblclick", "legendMouseover", "legendMouseout", "stateChange"),
            p = "classic";
        ...
        function b(x) {
            return x.each(function (b) {
                ...
                var z = k.selectAll("g.nv-wrap.nv-historicalBar-" + j).data([b[0].values]),
                    A = z.enter().append("g").attr("class", "nvd3 nv-wrap nv-historicalBar-" + j), B = A.append("defs"),
        ...
        var c, d, e, f, g = {top: 0, right: 0, bottom: 0, left: 0}, h = null, i = null,
            j = Math.floor(1e4 * Math.random()), k = null, l = d3.scale.linear(), m = d3.scale.linear(),
            n = function (a) {
                return a.x
            }, o = function (a) {
                return a.y
            }, p = [], q = [0], r = !1, s = !0, t = a.utils.defaultColor(),
            ...
            return b.each(function (k) {
                ...
                H.transition().call(f), q && (g.scale(d)._ticks(a.utils.calcTicksX(B / 100, k)).tickSize(-C, 0), G.select(".nv-x.nv-axis").attr("transform", "translate(0," + e.range()[0] + ")"), G.select(".nv-x.nv-axis").transition().call(g)), r && (h.scale(e)._ticks(a.utils.calcTicksY(C / 36, k)).tickSize(-B, 0), G.select(".nv-y.nv-axis").transition().call(h)), j.dispatch.on("elementMousemove", function (b) {
                    ...
                    k.filter(function (a, b) {
                        ...
                        var j = g.values[e];
                        void 0 !== j && (void 0 === d && (d = j), void 0 === i && (i = c.xScale()(c.x()(j, e))), l.push({
                            key: g.key,
                            value: c.y()(j, e),
        ...
        var d, e, f = b || a.models.historicalBar(), g = a.models.axis(), h = a.models.axis(), i = a.models.legend(),
            j = a.interactiveGuideline(), k = a.models.tooltip(), l = {top: 30, right: 90, bottom: 50, left: 90},
            m = a.utils.defaultColor(), n = null, o = null, p = !1, q = !0, r = !0, s = !1, t = !1, u = {}, v = null,
            w = null, x = d3.dispatch("tooltipHide", "stateChange", "changeState", "renderEnd"), y = 250;
        ...
        function b(q) {
            ...
            return q.each(function (b) {
                ...
                a.utils.initSVG(q);
                var u = q.selectAll("g.nv-legend").data([b]),
                    v = u.enter().append("g").attr("class", "nvd3 nv-legend").append("g"), w = u.select("g");
                u.attr("transform", "translate(" + c.left + "," + c.top + ")");
        ...
        var c = {top: 5, right: 0, bottom: 5, left: 0}, d = 400, e = 20, f = function (a) {
                return a.key
            }, g = a.utils.getColor(), h = 20, i = !0, j = 32, k = !0, l = !0, m = !1, n = !1,
            o = d3.dispatch("legendClick", "legendDblclick", "legendMouseover", "legendMouseout", "stateChange"),
            p = "classic";
        return b.dispatch = o, b.options = a.utils.optionsFunc.bind(b), b._options = Object.create({}, {
            width: {
        ...
        function b(r) {
            return v.reset(), v.models(e), r.each(function (b) {
                ...
                var w = i.selectAll("g.nv-wrap.nv-line").data([b]),
                    x = w.enter().append("g").attr("class", "nvd3 nv-wrap nv-line"), y = x.append("defs"),
                    z = x.append("g"), A = w.select("g");
        ...
        var c, d, e = a.models.scatter(), f = {top: 0, right: 0, bottom: 0, left: 0}, g = 960, h = 500, i = null,
            j = 1.5, k = a.utils.defaultColor(), l = function (a) {
                return a.x
            }, m = function (a) {
                return a.y
            }, n = function (a, b) {
        ...
        function b(j) {
            return y.reset(), y.models(e), p && y.models(f), q && y.models(g), j.each(function (j) {
                var v = d3.select(this), y = this;
                a.utils.initSVG(v);
                var B = a.utils.availableWidth(m, v, k), C = a.utils.availableHeight(n, v, k);
                if (b.update = function () {
                ...
                var E = v.selectAll("g.nv-wrap.nv-lineChart").data([j]),
                    F = E.enter().append("g").attr("class", "nvd3 nv-wrap nv-lineChart").append("g"), G = E.select("g");
                ...
                H.call(e), p && (f.scale(c)._ticks(a.utils.calcTicksX(B / 100, j)).tickSize(-C, 0), G.select(".nv-x.nv-axis").attr("transform", "translate(0," + d.range()[0] + ")"), G.select(".nv-x.nv-axis").call(f)), q && (g.scale(d)._ticks(a.utils.calcTicksY(C / 36, j)).tickSize(-B, 0), G.select(".nv-y.nv-axis").call(g)), h.dispatch.on("stateChange", function (a) {
                    ...
                    if (j.filter(function (a, b) {
                        ...
                        var i = f.values[h], j = b.y()(i, h);
                        null != j && e.highlightPoint(g, h, !0), void 0 !== i && (void 0 === d && (d = i), void 0 === k && (k = b.xScale()(b.x()(i, h))), m.push({
                            key: f.key,
                            value: j,
                            color: l(f, f.seriesIndex)
                        }))
                    }), m.length > 2) {
                        var n = b.yScale().invert(c.mouseY),
                            o = Math.abs(b.yScale().domain()[0] - b.yScale().domain()[1]), p = .03 * o,
                            q = a.nearestValueIndex(m.map(function (a) {
                                return a.value
                            }), n, p);
                        null !== q && (m[q].highlight = !0)
                    }
                    var r = f.tickFormat()(b.x()(d, h));
                    i.tooltip.chartContainer(y.parentNode).valueFormatter(function (a, b) {
                        return null == a ? "N/A" : g.tickFormat()(a)
                    }).data({value: r, index: h, series: m})(), i.renderGuideLine(k)
                    ...
                    j.filter(function (a, b) {
                        ...
                        if ("undefined" != typeof h) {
                            ...
                            f.push({point: h, pointIndex: g, pos: [d, i], seriesIndex: e.seriesIndex, series: e})
                        }
        ...
        var c, d, e = a.models.line(), f = a.models.axis(), g = a.models.axis(), h = a.models.legend(),
            i = a.interactiveGuideline(), j = a.models.tooltip(), k = {top: 30, right: 20, bottom: 50, left: 60},
            l = a.utils.defaultColor(), m = null, n = null, o = !0, p = !0, q = !0, r = !1, s = !1, t = a.utils.state(),
            u = null, v = null,
            w = d3.dispatch("tooltipShow", "tooltipHide", "stateChange", "changeState", "renderEnd"), x = 250;
        f.orient("bottom").tickPadding(7), g.orient(r ? "right" : "left"), j.valueFormatter(function (a, b) {
            return g.tickFormat()(a, b)
        }).headerFormatter(function (a, b) {
            return f.tickFormat()(a, b)
        });
        var y = a.utils.renderWatch(w, x), z = function (a) {
            return function () {
                return {
                    active: a.map(function (a) {
                        return !a.disabled
        ...
        function b(v) {
            return v.each(function (v) {
                ...
                function T() {
                    u.empty() || u.extent(I), la.data([u.empty() ? e.domain() : I]).each(function (a, b) {
                ...
                function U() {
                    I = u.empty() ? null : u.extent(), c = u.empty() ? e.domain() : u.extent(), K.brush({
                        extent: c,
                        brush: u
                    }), T(), l.width(W).height(X).color(v.map(function (a, b) {
                        return a.color || C(a, b)
                    }).filter(function (a, b) {
                        return !v[b].disabled && v[b].bar
                    })), j.width(W).height(X).color(v.map(function (a, b) {
                        return a.color || C(a, b)
                    }).filter(function (a, b) {
                        return !v[b].disabled && !v[b].bar
                    }));
                    var b = ea.select(".nv-focus .nv-barsWrap").datum($.length ? $.map(function (a, b) {
                            return {
                        ...
                        h = ea.select(".nv-focus .nv-linesWrap").datum(S(_) ? [{values: []}] : _.filter(function (a) {
                            return !a.disabled
                        }).map(function (a, b) {
                            return {
                                area: a.area,
                ...
                var $ = v.filter(function (a) {
                    return !a.disabled && a.bar
                }), _ = v.filter(function (a) {
                    return !a.bar
                });
                ...
                d.range([0, W]), e.domain(d3.extent(d3.merge(aa.concat(ba)), function (a) {
                    return a.x
                })).range([0, W]);
                var ca = V.selectAll("g.nv-wrap.nv-linePlusBar").data([v]),
                    da = ca.enter().append("g").attr("class", "nvd3 nv-wrap nv-linePlusBar").append("g"),
                    ea = ca.select("g");
                ...
                if (ga.append("g").attr("class", "nv-x nv-axis"), ga.append("g").attr("class", "nv-y1 nv-axis"), ga.append("g").attr("class", "nv-y2 nv-axis"), ga.append("g").attr("class", "nv-barsWrap"), ga.append("g").attr("class", "nv-linesWrap"), ga.append("g").attr("class", "nv-brushBackground"), ga.append("g").attr("class", "nv-x nv-brush"), D) {
                    ...
                    t.width(ha), ea.select(".nv-legendWrap").datum(v.map(function (a) {
                ...
                ca.attr("transform", "translate(" + w.left + "," + w.top + ")"), ea.select(".nv-context").style("display", E ? "initial" : "none"), m.width(W).height(Y).color(v.map(function (a, b) {
                    return a.color || C(a, b)
                }).filter(function (a, b) {
                    return !v[b].disabled && v[b].bar
                })), k.width(W).height(Y).color(v.map(function (a, b) {
                    return a.color || C(a, b)
                }).filter(function (a, b) {
                    return !v[b].disabled && !v[b].bar
                }));
                var ja = ea.select(".nv-context .nv-barsWrap").datum($.length ? $ : [{values: []}]),
                    ka = ea.select(".nv-context .nv-linesWrap").datum(S(_) ? [{values: []}] : _.filter(function (a) {
                        return !a.disabled
                    }));
                ...
                var la = ea.select(".nv-brushBackground").selectAll("g").data([I || u.extent()]),
                    ma = la.enter().append("g");
                ...
                na.selectAll("rect").attr("height", Y), na.selectAll(".resize").append("path").attr("d", J), t.dispatch.on("stateChange", function (a) {
        ...
        var c, d, e, f, g, h, i, j = a.models.line(), k = a.models.line(), l = a.models.historicalBar(),
            m = a.models.historicalBar(), n = a.models.axis(), o = a.models.axis(), p = a.models.axis(),
            q = a.models.axis(), r = a.models.axis(), s = a.models.axis(), t = a.models.legend(), u = d3.svg.brush(),
            v = a.models.tooltip(), w = {top: 30, right: 30, bottom: 30, left: 60},
            x = {top: 0, right: 30, bottom: 20, left: 60}, y = null, z = null, A = function (a) {
                return a.x
            }, B = function (a) {
                return a.y
            }, C = a.utils.defaultColor(), D = !0, E = !0, F = !1, G = !0, H = 50, I = null, J = null,
            K = d3.dispatch("brush", "stateChange", "changeState"), L = 0, M = a.utils.state(), N = null,
            O = " (left axis)", P = " (right axis)";
        ...
        function b(o) {
            return o.each(function (o) {
                function z(a) {
                    var b = +("e" == a), c = b ? 1 : -1, d = M / 3;
                    return "M" + .5 * c + "," + d + "A6,6 0 0 " + b + " " + 6.5 * c + "," + (d + 6) + "V" + (2 * d - 6) + "A6,6 0 0 " + b + " " + .5 * c + "," + 2 * d + "ZM" + 2.5 * c + "," + (d + 8) + "V" + (2 * d - 8) + "M" + 4.5 * c + "," + (d + 8) + "V" + (2 * d - 8)
                }

                function G() {
                    n.empty() || n.extent(y), U.data([n.empty() ? e.domain() : y]).each(function (a, b) {
                        var d = e(a[0]) - c.range()[0], f = K - e(a[1]);
                ...
                a.utils.initSVG(I);
                var K = a.utils.availableWidth(t, I, q), L = a.utils.availableHeight(u, I, q) - v,
                    M = v - r.top - r.bottom;
                if (b.update = function () {
                ...
                W.selectAll("rect").attr("height", M), W.selectAll(".resize").append("path").attr("d", z), H(), k.scale(e)._ticks(a.utils.calcTicksX(K / 100, o)).tickSize(-M, 0), Q.select(".nv-context .nv-x.nv-axis").attr("transform", "translate(0," + f.range()[0] + ")"), d3.transition(Q.select(".nv-context .nv-x.nv-axis")).call(k), l.scale(f)._ticks(a.utils.calcTicksY(M / 36, o)).tickSize(-K, 0), d3.transition(Q.select(".nv-context .nv-y.nv-axis")).call(l), Q.select(".nv-context .nv-x.nv-axis").attr("transform", "translate(0," + f.range()[0] + ")"), m.dispatch.on("stateChange", function (a) {
                    ...
                    if (o.filter(function (a, b) {
                        ...
                        var l = n.empty() ? e.domain() : n.extent(), m = i.values.filter(function (a, b) {
                        ...
                        var l = b.yScale().invert(c.mouseY),
                            m = Math.abs(b.yScale().domain()[0] - b.yScale().domain()[1]), q = .03 * m,
                            r = a.nearestValueIndex(k.map(function (a) {
                                return a.value
                            }), l, q);
                        null !== r && (k[r].highlight = !0)
                    }
                    var t = i.tickFormat()(b.x()(d, f));
                    p.tooltip.chartContainer(J.parentNode).valueFormatter(function (a, b) {
                        return null == a ? "N/A" : j.tickFormat()(a)
                    }).data({value: t, index: f, series: k})(), p.renderGuideLine(h)
        ...
        var c, d, e, f, g = a.models.line(), h = a.models.line(), i = a.models.axis(), j = a.models.axis(),
            k = a.models.axis(), l = a.models.axis(), m = a.models.legend(), n = d3.svg.brush(), o = a.models.tooltip(),
            p = a.interactiveGuideline(), q = {top: 30, right: 30, bottom: 30, left: 60},
            r = {top: 0, right: 30, bottom: 20, left: 60}, s = a.utils.defaultColor(), t = null, u = null, v = 50,
            w = !1, x = !0, y = null, z = null, A = d3.dispatch("brush", "stateChange", "changeState"), B = 250,
            C = a.utils.state(), D = null;
        g.clipEdge(!0).duration(0), h.interactive(!1), h.pointActive(function (a) {
            return !1
        }), i.orient("bottom").tickPadding(5), j.orient("left"), k.orient("bottom").tickPadding(5), l.orient("left"), o.valueFormatter(function (a, b) {
        ...
        function b(E) {
            return C.reset(), E.each(function (b) {
                ...
                var J = p.selectAll("g.nv-wrap.nv-multibar").data([b]),
                    K = J.enter().append("g").attr("class", "nvd3 nv-wrap nv-multibar"), L = K.append("defs"),
                    M = K.append("g"), N = J.select("g");
        ...
        var c, d, e, f, g, h, i, j = {top: 0, right: 0, bottom: 0, left: 0}, k = 960, l = 500, m = d3.scale.ordinal(),
            n = d3.scale.linear(), o = Math.floor(1e4 * Math.random()), p = null, q = function (a) {
                return a.x
            }, r = function (a) {
                return a.y
            }, s = [0], t = !0, u = !1, v = "zero", w = a.utils.defaultColor(), x = !1, y = null, z = 500, A = .1,
            B = d3.dispatch("chartClick", "elementClick", "elementDblClick", "elementMouseover", "elementMouseout", "elementMousemove", "renderEnd"),
            C = a.utils.renderWatch(B, z), D = 0;
        ...
        function b(j) {
            return E.reset(), E.models(e), r && E.models(f), s && E.models(g), j.each(function (j) {
                var A = d3.select(this);
                a.utils.initSVG(A);
                var E = a.utils.availableWidth(l, A, k), I = a.utils.availableHeight(m, A, k);
                if (b.update = function () {
                    0 === D ? A.call(b) : A.transition().duration(D).call(b)
                }, b.container = this, y.setter(H(j), b.update).getter(G(j)).update(), y.disabled = j.map(function (a) {
                    return !!a.disabled
                }), !z) {
                    var J;
                    z = {};
                ...
                if (!(j && j.length && j.filter(function (a) {
                    return a.values.length
                }).length)) return a.utils.noData(b, A), b;
                A.selectAll(".nv-noData").remove(), c = e.xScale(), d = e.yScale();
                var K = A.selectAll("g.nv-wrap.nv-multiBarWithLegend").data([j]),
                    L = K.enter().append("g").attr("class", "nvd3 nv-wrap nv-multiBarWithLegend").append("g"),
                    M = K.select("g");
                if (L.append("g").attr("class", "nv-x nv-axis"), L.append("g").attr("class", "nv-y nv-axis"), L.append("g").attr("class", "nv-barsWrap"), L.append("g").attr("class", "nv-legendWrap"), L.append("g").attr("class", "nv-controlsWrap"), q && (h.width(E - C()), M.select(".nv-legendWrap").datum(j).call(h), k.top != h.height() && (k.top = h.height(), I = a.utils.availableHeight(m, A, k)), M.select(".nv-legendWrap").attr("transform", "translate(" + C() + "," + -k.top + ")")), o) {
                    var N = [{key: p.grouped || "Grouped", disabled: e.stacked()}, {
                ...
                K.attr("transform", "translate(" + k.left + "," + k.top + ")"), t && M.select(".nv-y.nv-axis").attr("transform", "translate(" + E + ",0)"), e.disabled(j.map(function (a) {
                    return a.disabled
                })).width(E).height(I).color(j.map(function (a, b) {
                    return a.color || n(a, b)
                }).filter(function (a, b) {
                    return !j[b].disabled
                }));
                var O = M.select(".nv-barsWrap").datum(j.filter(function (a) {
                    return !a.disabled
                }));
                if (O.call(e), r) {
                    f.scale(c)._ticks(a.utils.calcTicksX(E / 100, j)).tickSize(-I, 0), M.select(".nv-x.nv-axis").attr("transform", "translate(0," + d.range()[0] + ")"), M.select(".nv-x.nv-axis").call(f);
                    var P = M.select(".nv-x.nv-axis > g").selectAll("g");
                    if (P.selectAll("line, text").style("opacity", 1), v) {
                        var Q = function (a, b) {
                            return "translate(" + a + "," + b + ")"
                        }, R = 5, S = 17;
                        P.selectAll("text").attr("transform", function (a, b, c) {
                            return Q(0, c % 2 == 0 ? R : S)
                        });
                        var T = d3.selectAll(".nv-x.nv-axis .nv-wrap g g text")[0].length;
                        M.selectAll(".nv-x.nv-axis .nv-axisMaxMin text").attr("transform", function (a, b) {
                            return Q(0, 0 === b || T % 2 !== 0 ? S : R)
                        })
                    }
                    w && M.selectAll(".tick text").call(a.utils.wrapTicks, b.xAxis.rangeBand()), u && P.filter(function (a, b) {
                        return b % Math.ceil(j[0].values.length / (E / 100)) !== 0
                ...
                s && (g.scale(d)._ticks(a.utils.calcTicksY(I / 36, j)).tickSize(-E, 0), M.select(".nv-y.nv-axis").call(g)), h.dispatch.on("stateChange", function (a) {
                    for (var c in a) y[c] = a[c];
                    B.stateChange(y), b.update()
                }), i.dispatch.on("legendClick", function (a, c) {
                    if (a.disabled) {
                        switch (N = N.map(function (a) {
                ...
                }), B.on("changeState", function (a) {
                    "undefined" != typeof a.disabled && (j.forEach(function (b, c) {
                        b.disabled = a.disabled[c]
                    }), y.disabled = a.disabled), "undefined" != typeof a.stacked && (e.stacked(a.stacked), y.stacked = a.stacked, F = a.stacked), b.update()
                })
            }), E.renderEnd("multibarchart immediate"), b
        }

        var c, d, e = a.models.multiBar(), f = a.models.axis(), g = a.models.axis(), h = a.models.legend(),
            i = a.models.legend(), j = a.models.tooltip(), k = {top: 30, right: 20, bottom: 50, left: 60}, l = null,
            m = null, n = a.utils.defaultColor(), o = !0, p = {}, q = !0, r = !0, s = !0, t = !1, u = !0, v = !1,
            w = !1, x = 0, y = a.utils.state(), z = null, A = null,
            B = d3.dispatch("stateChange", "changeState", "renderEnd"), C = function () {
                return o ? 180 : 0
            }, D = 250;
        y.stacked = !1, e.stacked(!1), f.orient("bottom").tickPadding(7).showMaxMin(!1).tickFormat(function (a) {
            return a
        ...
        var E = a.utils.renderWatch(B), F = !1, G = function (a) {
            return function () {
                return {
                    active: a.map(function (a) {
                        return !a.disabled
            ...
            return function (b) {
                void 0 !== b.stacked && (F = b.stacked), void 0 !== b.active && a.forEach(function (a, c) {
                    a.disabled = !b.active[c]
                })
            }
        };
        return e.dispatch.on("elementMouseover.tooltip", function (a) {
            ...
            j()
        }), b.dispatch = B, b.multibar = e, b.legend = h, b.controls = i, b.xAxis = f, b.yAxis = g, b.state = y, b.tooltip = j, b.options = a.utils.optionsFunc.bind(b), b._options = Object.create({}, {
            width: {
                get: function () {
                    return l
                }, set: function (a) {
                ...
                get: function () {
                    ...
                    D = a, e.duration(D), f.duration(D), g.duration(D), E.reset(D)
                }
            }, color: {
                get: function () {
                    return n
        ...
        var c, d, e, f, g, h, i, j = {top: 0, right: 0, bottom: 0, left: 0}, k = 960, l = 500,
            m = Math.floor(1e4 * Math.random()), n = null, o = d3.scale.ordinal(), p = d3.scale.linear(),
            q = function (a) {
                return a.x
            }, r = function (a) {
                return a.y
                ...
                return a.yErr
            }, t = [0], u = a.utils.defaultColor(), v = null, w = !1, x = !1, y = !1, z = 60, A = .1, B = d3.format(",.2f"),
            C = 250,
        ...
        function b(j) {
            return C.reset(), C.models(e), r && C.models(f), s && C.models(g), j.each(function (j) {
                ...
                if (G.append("g").attr("class", "nv-x nv-axis"), G.append("g").attr("class", "nv-y nv-axis").append("g").attr("class", "nv-zeroLine").append("line"), G.append("g").attr("class", "nv-barsWrap"), G.append("g").attr("class", "nv-legendWrap"), G.append("g").attr("class", "nv-controlsWrap"), q && (h.width(C - y()), H.select(".nv-legendWrap").datum(j).call(h), k.top != h.height() && (k.top = h.height(), D = a.utils.availableHeight(m, w, k)), H.select(".nv-legendWrap").attr("transform", "translate(" + y() + "," + -k.top + ")")), o) {
                    var I = [{key: p.grouped || "Grouped", disabled: e.stacked()}, {
                        key: p.stacked || "Stacked",
                        disabled: !e.stacked()
                    }];
        ...
        var c, d, e = a.models.multiBarHorizontal(), f = a.models.axis(), g = a.models.axis(),
            h = a.models.legend().height(30), i = a.models.legend().height(30), j = a.models.tooltip(),
            k = {top: 30, right: 20, bottom: 50, left: 60}, l = null, m = null, n = a.utils.defaultColor(), o = !0,
            p = {}, q = !0, r = !0, s = !0, t = !1, u = a.utils.state(), v = null, w = null,
            x = d3.dispatch("stateChange", "changeState", "renderEnd"), y = function () {
                return o ? 180 : 0
            }, z = 250;
        ...
        function b(j) {
            return j.each(function (j) {
                function n(a) {
                    var b = 2 === j[a.seriesIndex].yAxis ? B : A;
                    a.value = a.point.x, a.series = {
                        value: a.point.y,
                        color: a.point.color,
                        key: a.series.key
                    }, D.duration(0).valueFormatter(function (a, c) {
                ...
                function E(a) {
                    ...
                    a.value = a.point.x, a.series = {
                        ...
                        color: a.point.color,
                        key: a.series.key
                    }, D.duration(100).valueFormatter(function (a, c) {
                        return b.tickFormat()(a, c)
                    }).data(a).hidden(!1)
                }
                ...
                function F(a) {
                    var b = 2 === j[a.seriesIndex].yAxis ? B : A;
                    a.point.x = x.x()(a.point), a.point.y = x.y()(a.point), D.duration(0).valueFormatter(function (a, c) {
                        return b.tickFormat()(a, c)
                    }).data(a).hidden(!1)
                }

                function G(a) {
                    var b = 2 === j[a.data.series].yAxis ? B : A;
                    a.value = v.x()(a.data), a.series = {
                        value: v.y()(a.data),
                        color: a.color,
                        key: a.data.key
                    }, D.duration(0).valueFormatter(function (a, c) {
                ...
                var I = a.utils.availableWidth(g, H, e), J = a.utils.availableHeight(h, H, e),
                ...
                o.domain(d3.extent(d3.merge(S.concat(T)), function (a) {
                    return k(a)
                })).range([0, I]);
                var U = H.selectAll("g.wrap.multiChart").data([j]),
                ...
                var W = U.select("g"), X = j.map(function (a, b) {
                    return j[b].color || f(a, b)
                });
                if (i) {
                    var Y = C.align() ? I / 2 : I, Z = C.align() ? Y : 0;
                    C.width(Y), C.color(X), W.select(".legendWrap").datum(j.map(function (a) {
                ...
                r.width(I).height(J).interpolate(m).color(X.filter(function (a, b) {
                    return !j[b].disabled && 1 == j[b].yAxis && "line" == j[b].type
                })), s.width(I).height(J).interpolate(m).color(X.filter(function (a, b) {
                    return !j[b].disabled && 2 == j[b].yAxis && "line" == j[b].type
                })), t.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 1 == j[b].yAxis && "scatter" == j[b].type
                })), u.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 2 == j[b].yAxis && "scatter" == j[b].type
                })), v.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 1 == j[b].yAxis && "bar" == j[b].type
                })), w.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 2 == j[b].yAxis && "bar" == j[b].type
                })), x.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 1 == j[b].yAxis && "area" == j[b].type
                })), y.width(I).height(J).color(X.filter(function (a, b) {
                    return !j[b].disabled && 2 == j[b].yAxis && "area" == j[b].type
                })), W.attr("transform", "translate(" + e.left + "," + e.top + ")");
                var $ = W.select(".lines1Wrap").datum(K.filter(function (a) {
                    return !a.disabled
                })), _ = W.select(".scatters1Wrap").datum(M.filter(function (a) {
                    return !a.disabled
                })), aa = W.select(".bars1Wrap").datum(O.filter(function (a) {
                    return !a.disabled
                })), ba = W.select(".stack1Wrap").datum(Q.filter(function (a) {
                    return !a.disabled
                })), ca = W.select(".lines2Wrap").datum(L.filter(function (a) {
                    return !a.disabled
                })), da = W.select(".scatters2Wrap").datum(N.filter(function (a) {
                    return !a.disabled
                })), ea = W.select(".bars2Wrap").datum(P.filter(function (a) {
                    return !a.disabled
                })), fa = W.select(".stack2Wrap").datum(R.filter(function (a) {
                    return !a.disabled
                })), ga = Q.length ? Q.map(function (a) {
                    return a.values
                }).reduce(function (a, b) {
                    return a.map(function (a, c) {
                        return {x: a.x, y: a.y + b[c].y}
                    })
                }).concat([{x: 0, y: 0}]) : [], ha = R.length ? R.map(function (a) {
                    return a.values
                }).reduce(function (a, b) {
                    return a.map(function (a, c) {
                        return {x: a.x, y: a.y + b[c].y}
                ...
                p.domain(c || d3.extent(d3.merge(S).concat(ga), function (a) {
                    return a.y
                })).range([0, J]), q.domain(d || d3.extent(d3.merge(T).concat(ha), function (a) {
                    return a.y
                })).range([0, J]), r.yDomain(p.domain()), t.yDomain(p.domain()), v.yDomain(p.domain()), x.yDomain(p.domain()), s.yDomain(q.domain()), u.yDomain(q.domain()), w.yDomain(q.domain()), y.yDomain(q.domain()), Q.length && d3.transition(ba).call(x), R.length && d3.transition(fa).call(y), O.length && d3.transition(aa).call(v), P.length && d3.transition(ea).call(w), K.length && d3.transition($).call(r), L.length && d3.transition(ca).call(s), M.length && d3.transition(_).call(t), N.length && d3.transition(da).call(u), z._ticks(a.utils.calcTicksX(I / 100, j)).tickSize(-J, 0), W.select(".nv-x.nv-axis").attr("transform", "translate(0," + J + ")"), d3.transition(W.select(".nv-x.nv-axis")).call(z), A._ticks(a.utils.calcTicksY(J / 36, j)).tickSize(-I, 0), d3.transition(W.select(".nv-y1.nv-axis")).call(A), B._ticks(a.utils.calcTicksY(J / 36, j)).tickSize(-I, 0), d3.transition(W.select(".nv-y2.nv-axis")).call(B), W.select(".nv-y1.nv-axis").classed("nv-disabled", S.length ? !1 : !0).attr("transform", "translate(" + o.range()[0] + ",0)"), W.select(".nv-y2.nv-axis").classed("nv-disabled", T.length ? !1 : !0).attr("transform", "translate(" + o.range()[1] + ",0)"), C.dispatch.on("stateChange", function (a) {
                    b.update()
                }), r.dispatch.on("elementMouseover.tooltip", n), s.dispatch.on("elementMouseover.tooltip", n), r.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), s.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), t.dispatch.on("elementMouseover.tooltip", E), u.dispatch.on("elementMouseover.tooltip", E), t.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), u.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), x.dispatch.on("elementMouseover.tooltip", F), y.dispatch.on("elementMouseover.tooltip", F), x.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), y.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), v.dispatch.on("elementMouseover.tooltip", G), w.dispatch.on("elementMouseover.tooltip", G), v.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), w.dispatch.on("elementMouseout.tooltip", function (a) {
                    D.hidden(!0)
                }), v.dispatch.on("elementMousemove.tooltip", function (a) {
                    D()
                }), w.dispatch.on("elementMousemove.tooltip", function (a) {
                    D()
                })
            }), b
        }

        var c, d, e = {top: 30, right: 20, bottom: 50, left: 60}, f = a.utils.defaultColor(), g = null, h = null,
            i = !0, j = null, k = function (a) {
                return a.x
            }, l = function (a) {
                return a.y
            }, m = "monotone", n = !0, o = d3.scale.linear(), p = d3.scale.linear(), q = d3.scale.linear(),
            r = a.models.line().yScale(p), s = a.models.line().yScale(q), t = a.models.scatter().yScale(p),
            u = a.models.scatter().yScale(q), v = a.models.multiBar().stacked(!1).yScale(p),
            w = a.models.multiBar().stacked(!1).yScale(q), x = a.models.stackedArea().yScale(p),
            y = a.models.stackedArea().yScale(q), z = a.models.axis().scale(o).orient("bottom").tickPadding(5),
            A = a.models.axis().scale(p).orient("left"), B = a.models.axis().scale(q).orient("right"),
            C = a.models.legend().height(30), D = a.models.tooltip(), E = d3.dispatch();
        return b.dispatch = E, b.legend = C, b.lines1 = r, b.lines2 = s, b.scatters1 = t, b.scatters2 = u, b.bars1 = v, b.bars2 = w, b.stack1 = x, b.stack2 = y, b.xAxis = z, b.yAxis1 = A, b.yAxis2 = B, b.tooltip = D, b.options = a.utils.optionsFunc.bind(b), b._options = Object.create({}, {
            width: {
                get: function () {
                    return g
                }, set: function (a) {
                ...
                get: function () {
                    ...
                    k = a, r.x(a), s.x(a), t.x(a), u.x(a), v.x(a), w.x(a), x.x(a), y.x(a)
                }
            }, y: {
                get: function () {
                    return l
                }, set: function (a) {
                    l = a, r.y(a), s.y(a), t.y(a), u.y(a), x.y(a), y.y(a), v.y(a), w.y(a)
                }
            }, useVoronoi: {
                get: function () {
                    return n
                }, set: function (a) {
                    n = a, r.useVoronoi(a), s.useVoronoi(a), x.useVoronoi(a), y.useVoronoi(a)
                }
            }
        }), a.utils.initOptions(b), b
        ...
        function b(y) {
            return y.each(function (b) {
                ...
                var C = d3.select(this).selectAll("g.nv-wrap.nv-ohlcBar").data([b[0].values]),
                    D = C.enter().append("g").attr("class", "nvd3 nv-wrap nv-ohlcBar"), E = D.append("defs"),
                    F = D.append("g"), G = C.select("g");
        ...
        function b(p) {
            return p.each(function (b) {
                function p(a) {
                    return F(h.map(function (b) {
                        if (isNaN(a[b]) || isNaN(parseFloat(a[b]))) {
                            var c = g[b].domain(), d = g[b].range(), e = c[0] - (c[1] - c[0]) / 9;
                            if (J.indexOf(b) < 0) {
                ...
                var z = v.selectAll("g.nv-wrap.nv-parallelCoordinates").data([b]),
                    A = z.enter().append("g").attr("class", "nvd3 nv-wrap nv-parallelCoordinates"), B = A.append("g"),
                    C = z.select("g");
                ...
                var D, E, F = d3.svg.line().interpolate("cardinal").tension(n), G = d3.svg.axis().orient("left"),
                    H = d3.behavior.drag().on("dragstart", r).on("drag", s).on("dragend", t),
                    I = f.range()[1] - f.range()[0], J = [], K = [0 + I / 2, x - 12, w - I / 2, x - 12];
                ...
                M.enter().append("path"), M.exit().remove(), M.attr("d", p).attr("stroke", j), M.on("mouseover", function (a, b) {
                    ...
                    d3.select(this).classed("hover", !1), o.elementMouseout({label: a.name, data: a.data, index: b})
                });
                ...
                }), N.exit().remove(), N.select(".nv-label").style("cursor", "move").attr("dy", "-1em").attr("text-anchor", "middle").text(String).on("mouseover", function (a, b) {
                    o.elementMouseover({
                        dim: a,
        ...
        var c = {top: 30, right: 0, bottom: 10, left: 0}, d = null, e = null, f = d3.scale.ordinal(), g = {}, h = [],
            i = [], j = a.utils.defaultColor(), k = [], l = [], m = [], n = 1,
        ...
        function b(E) {
            return D.reset(), E.each(function (b) {
                ...
                var N = i.selectAll(".nv-wrap.nv-pie").data(b),
                    O = N.enter().append("g").attr("class", "nvd3 nv-wrap nv-pie nv-chart-" + h), P = O.append("g"),
                    Q = N.select("g"), R = P.append("g").attr("class", "nv-pie");
                ...
                X.attr("class", "nv-slice"), X.on("mouseover", function (a, b) {
                    ...
                    A.elementClick({data: a.data, index: b, color: d3.select(this).style("fill")})
                ...
                if (V.select("path").transition().attr("d", function (a, b) {
                    ...
                    W.watchTransition(D, "pie labels").attr("transform", function (a, b) {
                        ...
                        var c = (a.endAngle - a.startAngle) / (2 * Math.PI), d = "";
        ...
        var c = {top: 0, right: 0, bottom: 0, left: 0}, d = 500, e = 500, f = function (a) {
                ...
                return a.y
            }, h = Math.floor(1e4 * Math.random()), i = null, j = a.utils.defaultColor(), k = d3.format(",.2f"), l = !0,
            m = !1, n = "key", o = .02, p = !1, q = !1, r = !0, s = 0, t = !1, u = !1, v = !1, w = !1, x = 0, y = .5,
            z = [],
            A = d3.dispatch("chartClick", "elementClick", "elementDblClick", "elementMouseover", "elementMouseout", "elementMousemove", "renderEnd"),
            B = [], C = [], D = a.utils.renderWatch(A);
        ...
        function b(e) {
            return q.reset(), q.models(c), e.each(function (e) {
                ...
                var t = k.selectAll("g.nv-wrap.nv-pieChart").data([e]),
                    u = t.enter().append("g").attr("class", "nvd3 nv-wrap nv-pieChart").append("g"), v = t.select("g");
        ...
        var c = a.models.pie(), d = a.models.legend(), e = a.models.tooltip(),
            f = {top: 30, right: 20, bottom: 20, left: 20}, g = null, h = null, i = !0, j = "top",
            k = a.utils.defaultColor(), l = a.utils.state(), m = null, n = null, o = 250,
            p = d3.dispatch("stateChange", "changeState", "renderEnd");
        ...
        function b(N) {
            return P.reset(), N.each(function (b) {
                    ...
                    if (M === !0) {
                        ...
                        var c = d3.geom.polygon([[-10, -10], [-10, i + 10], [h + 10, i + 10], [h + 10, -10]]),
                            d = d3.geom.voronoi(a).map(function (b, d) {
                                return {data: c.clip(b), series: a[d][2], point: a[d][3]}
                            });
                        ...
                        if (C && f.style("fill", d3.rgb(230, 230, 230)).style("fill-opacity", .4).style("stroke-opacity", 1).style("stroke", d3.rgb(200, 200, 200)), B) {
                            U.select(".nv-point-clips").selectAll("*").remove();
                            var o = U.select(".nv-point-clips").selectAll("clipPath").data(a);
                            o.enter().append("svg:clipPath").attr("id", function (a, b) {
                                return "nv-clip-" + k + "-" + b
                        ...
                        var r = function (a, c) {
                            ...
                            if (void 0 !== d) {
                                ...
                                var f = l.node().getBoundingClientRect(),
                                    ...
                                    i = window.pageXOffset || document.documentElement.scrollLeft, k = {
                                ...
                                c({
                                    ...
                                    series: d,
                                    pos: k,
                                    relativePos: [m(p(e, a.point)) + g.left, n(q(e, a.point)) + g.top],
                        ...
                        e.on("click", function (a) {
                            ...
                            r(a, L.elementDblClick)
                        }).on("mouseover", function (a) {
                            r(a, L.elementMouseover)
                        }).on("mouseout", function (a, b) {
                            r(a, L.elementMouseout)
                        })
                        ...
                        L.elementClick({
                            ...
                            relativePos: [m(p(e, c)) + g.left, n(q(e, c)) + g.top],
                            seriesIndex: a.series,
                            pointIndex: c
                        })
                ...
                m.domain(E || d3.extent(T.map(function (a) {
                    return a.x
                }).concat(t))), y && b[0] ? m.range(G || [(R * z + R) / (2 * b[0].values.length), R - R * (1 + z) / (2 * b[0].values.length)]) : m.range(G || [0, R]), n.domain(F || d3.extent(T.map(function (a) {
                    return a.y
                }).concat(u))).range(H || [S, 0]), o.domain(I || d3.extent(T.map(function (a) {
                    return a.size
                }).concat(v))).range(J || Q), K = m.domain()[0] === m.domain()[1] || n.domain()[0] === n.domain()[1], m.domain()[0] === m.domain()[1] && (m.domain()[0] ? m.domain([m.domain()[0] - .01 * m.domain()[0], m.domain()[1] + .01 * m.domain()[1]]) : m.domain([-1, 1])), n.domain()[0] === n.domain()[1] && (n.domain()[0] ? n.domain([n.domain()[0] - .01 * n.domain()[0], n.domain()[1] + .01 * n.domain()[1]]) : n.domain([-1, 1])), isNaN(m.domain()[0]) && m.domain([-1, 1]), isNaN(n.domain()[0]) && n.domain([-1, 1]), c = c || m, d = d || n, e = e || o;
                var U = l.selectAll("g.nv-wrap.nv-scatter").data([b]),
                    V = U.enter().append("g").attr("class", "nvd3 nv-wrap nv-scatter nv-chart-" + k),
                    W = V.append("defs"), X = V.append("g"), Y = U.select("g");
        ...
        var c, d, e, f, g = {top: 0, right: 0, bottom: 0, left: 0}, h = null, i = null, j = a.utils.defaultColor(),
            k = Math.floor(1e5 * Math.random()), l = null, m = d3.scale.linear(), n = d3.scale.linear(),
            o = d3.scale.linear(), p = function (a) {
                ...
                return 25
            }, E = null, F = null, G = null, H = null, I = null, J = null, K = !1,
            L = d3.dispatch("elementClick", "elementDblClick", "elementMouseover", "elementMouseout", "renderEnd"),
            M = !0, N = 250, O = !1, P = a.utils.renderWatch(L, N), Q = [16, 256];
        ...
        var c = a.models.scatter(), d = a.models.axis(), e = a.models.axis(), f = a.models.legend(),
            g = a.models.distribution(), h = a.models.distribution(), i = a.models.tooltip(),
            j = {top: 30, right: 20, bottom: 50, left: 75}, k = null, l = null, m = null, n = a.utils.defaultColor(),
            o = c.xScale(), p = c.yScale(), q = !1, r = !1, s = !0, t = !0, u = !0, v = !1, w = a.utils.state(),
        ...
        var c, d, e, f, g = {top: 2, right: 0, bottom: 2, left: 0}, h = 400, i = 32, j = null, k = !0,
            l = d3.scale.linear(), m = d3.scale.linear(), n = function (a) {
                return a.x
            }, o = function (a) {
                return a.y
        ...
        function b(p) {
            return p.each(function (p) {
                ...
                var w = s.selectAll("g.nv-wrap.nv-sparklineplus").data([p]),
                    x = w.enter().append("g").attr("class", "nvd3 nv-wrap nv-sparklineplus"), y = x.append("g"),
                    z = w.select("g");
        ...
        var c, d, e = a.models.sparkline(), f = {top: 15, right: 100, bottom: 10, left: 50}, g = null, h = null, i = [],
            j = !1, k = d3.format(",r"), l = d3.format(",.2f"), m = !0, n = !0, o = !1, p = null;
        ...
        function b(m) {
            return u.reset(), u.models(r), m.each(function (m) {
                var s = f - e.left - e.right, v = g - e.top - e.bottom;
                ...
                var y = j.selectAll("g.nv-wrap.nv-stackedarea").data([m]),
                    z = y.enter().append("g").attr("class", "nvd3 nv-wrap nv-stackedarea"), A = z.append("defs"),
                    B = z.append("g"), C = y.select("g");
                ...
                }).forceY([0]).color(m.map(function (a, b) {
                ...
                }).interpolate(p), F = d3.svg.area().x(function (a, b) {
                    return c(k(a, b))
                }).y0(function (a) {
                    return d(a.display.y0)
                }).y1(function (a) {
                ...
                }), G.exit().remove(), G.style("fill", function (a, b) {
                    return a.color || h(a, a.seriesIndex)
                }).style("stroke", function (a, b) {
                    return a.color || h(a, a.seriesIndex)
        ...
        var c, d, e = {top: 0, right: 0, bottom: 0, left: 0}, f = 960, g = 500, h = a.utils.defaultColor(),
            i = Math.floor(1e5 * Math.random()), j = null, k = function (a) {
                return a.x
            }, l = function (a) {
                return a.y
            }, m = "stack", n = "zero", o = "default", p = "linear", q = !1, r = a.models.scatter(), s = 250,
        ...
        function b(k) {
            return H.reset(), H.models(e), r && H.models(f), s && H.models(g), k.each(function (k) {
                ...
                var P = z.selectAll("g.nv-wrap.nv-stackedAreaChart").data([k]),
                    Q = P.enter().append("g").attr("class", "nvd3 nv-wrap nv-stackedAreaChart").append("g"),
                    R = P.select("g");
                ...
                if (p) {
                    var T = [{
                        ...
                        key: D.expanded || "Expanded",
                        metaKey: "Expanded",
                        disabled: "expand" != e.style(),
                        style: "expand"
                    }, {
                        key: D.stack_percent || "Stack %",
                ...
                P.attr("transform", "translate(" + l.left + "," + l.top + ")"), t && R.select(".nv-y.nv-axis").attr("transform", "translate(" + M + ",0)"), u && (j.width(M).height(N).margin({
                    left: l.left,
                    top: l.top
                }).svgContainer(z).xScale(c), P.select(".nv-interactive").call(j)), e.width(M).height(N);
                ...
                e.dispatch.on("areaClick.toggle", function (a) {
                    ...
                    if (k.filter(function (a, b) {
                        ...
                        var k = f.values[g], m = b.y()(k, g);
                        if (null != m && e.highlightPoint(j, g, !0), "undefined" != typeof k) {
                    ...
                    v && "expand" != e.style() && i.length >= 2 && i.push({key: w, value: l, total: !0});
                    var p = f.tickFormat()(b.x()(d, g)), q = j.tooltip.valueFormatter();
                    "expand" === e.style() || "stack_percent" === e.style() ? (G || (G = q), q = d3.format(".1%")) : G && (q = G, G = null), j.tooltip.chartContainer(H.parentNode).valueFormatter(q).data({
                        value: p,
                        series: i
                    })(), j.renderGuideLine(h)
                }), j.dispatch.on("elementMouseout", function (a) {
        ...
        var c, d, e = a.models.stackedArea(), f = a.models.axis(), g = a.models.axis(), h = a.models.legend(),
            i = a.models.legend(), j = a.interactiveGuideline(), k = a.models.tooltip(),
            l = {top: 30, right: 25, bottom: 50, left: 60}, m = null, n = null, o = a.utils.defaultColor(), p = !0,
            q = !0, r = !0, s = !0, t = !1, u = !1, v = !0, w = "TOTAL", x = a.utils.state(), y = null, z = null,
            A = d3.dispatch("stateChange", "changeState", "renderEnd"), B = 250, C = ["Stacked", "Stream", "Expanded"],
            D = {}, E = 250;
        ...
        function b(u) {
            return t.reset(), u.each(function (b) {
                ...
                function u(a) {
                    var b = d3.interpolate(p.domain(), [a.x, a.x + a.dx]), c = d3.interpolate(q.domain(), [a.y, 1]),
                ...
                l = d3.select(this);
                var v, w = a.utils.availableWidth(g, l, f), x = a.utils.availableHeight(h, l, f),
                    y = Math.min(w, x) / 2;
                a.utils.initSVG(l);
                ...
                z.attr("transform", "translate(" + w / 2 + "," + x / 2 + ")"), l.on("click", function (a, b) {
                    o.chartClick({data: a, index: b, pos: d3.event, id: k})
                ...
                }).each(t).on("mouseover", function (a, b) {
                    d3.select(this).classed("hover", !0).style("opacity", .8), o.elementMouseover({
                        data: a,
                        color: d3.select(this).style("fill")
                    })
                }).on("mouseout", function (a, b) {
                    d3.select(this).classed("hover", !1).style("opacity", 1), o.elementMouseout({data: a})
                }).on("mousemove", function (a, b) {
        ...
        var c, d, e, f = {top: 0, right: 0, bottom: 0, left: 0}, g = null, h = null, i = "count", j = {
            ...
            }, k = Math.floor(1e4 * Math.random()), l = null, m = a.utils.defaultColor(), n = 500,
            o = d3.dispatch("chartClick", "elementClick", "elementDblClick", "elementMousemove", "elementMouseover", "elementMouseout", "renderEnd"),
            p = d3.scale.linear().range([0, 2 * Math.PI]), q = d3.scale.sqrt(),
            r = d3.layout.partition().sort(null).value(function (a) {
                return 1
        ...
        var c = a.models.sunburst(), d = a.models.tooltip(), e = {top: 30, right: 20, bottom: 20, left: 20}, f = null,
            g = null, h = a.utils.defaultColor(), i = (Math.round(1e5 * Math.random()), null), j = null, k = 250,
            l = d3.dispatch("stateChange", "changeState", "renderEnd");
        d.duration(0);
