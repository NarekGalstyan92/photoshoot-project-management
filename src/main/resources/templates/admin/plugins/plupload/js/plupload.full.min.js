!function (e, t) {
    ...
    var s = {}, u = "moxie/core/utils/Basic", c = "moxie/core/utils/Env", l = "moxie/core/I18n",
        d = "moxie/core/utils/Mime", h = "moxie/core/utils/Dom", f = "moxie/core/Exceptions",
        p = "moxie/core/EventTarget", m = "moxie/runtime/Runtime", g = "moxie/runtime/RuntimeClient",
        v = "moxie/file/FileInput", w = "moxie/core/utils/Encode", y = "moxie/file/Blob", E = "moxie/file/File",
        _ = "moxie/file/FileDrop", b = "moxie/file/FileReader", x = "moxie/core/utils/Url",
        R = "moxie/runtime/RuntimeTarget", A = "moxie/file/FileReaderSync", I = "moxie/xhr/FormData",
        T = "moxie/xhr/XMLHttpRequest", S = "moxie/runtime/Transporter", O = "moxie/image/Image",
        D = "moxie/runtime/html5/Runtime", N = "moxie/core/utils/Events", L = "moxie/runtime/html5/file/FileInput",
        C = "moxie/runtime/html5/file/Blob", M = "moxie/runtime/html5/file/FileDrop",
        F = "moxie/runtime/html5/file/FileReader", P = "moxie/runtime/html5/xhr/XMLHttpRequest",
        H = "moxie/runtime/html5/utils/BinaryReader", B = "moxie/runtime/html5/image/JPEGHeaders",
        k = "moxie/runtime/html5/image/ExifParser", U = "moxie/runtime/html5/image/JPEG",
        G = "moxie/runtime/html5/image/PNG", z = "moxie/runtime/html5/image/ImageInfo",
        q = "moxie/runtime/html5/image/MegaPixel", j = "moxie/runtime/html5/image/Image",
        X = "moxie/runtime/flash/Runtime", V = "moxie/runtime/flash/file/FileInput",
        W = "moxie/runtime/flash/file/Blob", Y = "moxie/runtime/flash/file/FileReader",
        ...
        Q = "moxie/runtime/silverlight/Runtime", ee = "moxie/runtime/silverlight/file/FileInput",
        te = "moxie/runtime/silverlight/file/Blob", ne = "moxie/runtime/silverlight/file/FileDrop",
        ie = "moxie/runtime/silverlight/file/FileReader", re = "moxie/runtime/silverlight/file/FileReaderSync",
        oe = "moxie/runtime/silverlight/xhr/XMLHttpRequest", ae = "moxie/runtime/silverlight/runtime/Transporter",
        se = "moxie/runtime/silverlight/image/Image", ue = "moxie/runtime/html4/Runtime",
        ce = "moxie/runtime/html4/file/FileInput", le = "moxie/runtime/html4/file/FileReader",
        de = "moxie/runtime/html4/xhr/XMLHttpRequest", he = "moxie/runtime/html4/image/Image";
    i(u, [], function () {
        var e = function (e) {
            var t;
        ...
        var n = function (e) {
            var t = "", n = "?", i = "function", r = "undefined", o = "object", a = "major", s = "model", u = "name",
                c = "type", l = "vendor", d = "version", h = "architecture", f = "console", p = "mobile", m = "tablet",
                g = {
                    has: function (e, t) {
                    ...
                    rgx: function () {
                        for (var t, n = 0, a, s, u, c, l, d, h = arguments; n < h.length; n += 2) {
                            ...
                            for (a = s = 0; a < f.length; a++) if (l = f[a].exec(this.getUA())) {
                    ...
                    engine: [[/windows.+\sedge\/([\w\.]+)/i], [d, [u, "EdgeHTML"]], [/(presto)\/([\w\.]+)/i, /(webkit|trident|netfront|netsurf|amaya|lynx|w3m)\/([\w\.]+)/i, /(khtml|tasman|links)[\/\s]\(?([\w\.]+)/i, /(icab)[\/\s]([23]\.[\d\.]+)/i], [u, d], [/rv\:([\w\.]+).*(gecko)/i], [d, u]],
            ...
            i = {
                mimes: {}, extensions: {}, addMimeType: function (e) {
                    ...
                    for (o = 0; o < t.length; o++) for (r = t[o].extensions.split(/\s*,\s*/), a = 0; a < r.length; a++) {
                        if ("*" === r[a]) return [];
                        if (s = i.mimes[r[a]], s && -1 === e.inArray(s, u) && u.push(s), n && /^\w+$/.test(r[a])) u.push("." + r[a]); else if (!s) return []
                    }
                    return u
        ...
        function i() {
            ...
            n.extend(this, {
                uid: null, init: function () {
                    ...
                    return t ? !(!e[this.uid] || !e[this.uid][t]) : !!e[this.uid]
            ...
            e = e || {}, a[d] = this, o = t.extend({
                ...
                can: function (e, n) {
                    ...
                    if ("string" === t.typeOf(e) && "undefined" === t.typeOf(n) && (e = r.parseCaps(e)), "object" === t.typeOf(e)) {
                        for (var a in e) if (!this.can(a, e[a], i)) return !1;
                        return !0
                    }
        ...
        return r.order = "html5,flash,silverlight,html4", r.getRuntime = function (e) {
            ...
            if ("undefined" === t.typeOf(i) && (i = "browser"), n && !t.isEmptyObj(e)) {
                ...
                }), r) return -1 !== t.inArray(i, r) ? i : r[0];
                if (r === !1) return !1
            }
            return i
        }, r.capTrue = function () {
        ...
        var e = function (e) {
            ...
            var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", r, o, a, s, u, c, l, d, h = 0,
                f = 0, p = "", m = [];
            if (!e) return e;
            e += "";
        ...
        function a() {
            ...
            o.call(this), e.extend(this, {
                uid: e.guid("uid_"), readyState: a.EMPTY, result: null, error: null, readAsBinaryString: function (e) {
        ...
        var e = function (t, n) {
            ...
            var n = {http: 80, https: 443}, i = "object" == typeof t ? t : e(t);
        ...
        function f() {
            ...
            var v = this, w = {
                    ...
                    responseText: null,
                    response: null
                }, y = !0, E, _, b = {}, x, R, A = null, I = null, T = !1, S = !1, O = !1, D = !1, N = !1, L = !1, C, M,
                F = null, P = null, H = {}, B, k = "", U;
            e.extend(this, w, {
                uid: e.guid("uid_"), upload: new h, open: function (o, a, s, u, c) {
                    var l;
                    ...
                    if (n instanceof s) H.ruid = n.ruid, I = n.type || "application/octet-stream"; else if (n instanceof c) {
                        if (n.hasBlob()) {
                            var o = n.getBlob();
                            H.ruid = o.ruid, I = o.type || "application/octet-stream"
                        }
                    } else "string" == typeof n && (A = "UTF-8", I = "text/plain;charset=UTF-8", n = i.utf8_encode(n));
                    ...
                    if (N = !0, T = !1, ~e.inArray(n("readyState"), [f.UNSENT, f.OPENED, f.DONE])) n("readyState", f.UNSENT); else {
        ...
        function r() {
            ...
            n.call(this), e.extend(this, {
                ...
                transport: function (t, n, r) {
                    var a = this;
                    if (r = e.extend({chunk_size: 204798}, r), (s = r.chunk_size % 3) && (r.chunk_size += 3 - s), h = r.chunk_size, i.call(this), c = t, l = t.length, "string" === e.typeOf(r) || r.ruid) o.call(a, n, this.connectRuntime(r)); else {
                        var u = function (e, t) {
        ...
        function f() {
            function i(e) {
                e || (e = this.exec("Image", "getInfo")), !e.meta || !e.meta.thumb || e.meta.thumb.data instanceof l || (e.meta.thumb.data = new l(this.ruid, {
                    type: "image/jpeg",
                    data: e.meta.thumb.data
                })), this.size = e.size, this.width = e.width, this.height = e.height, this.type = e.type, this.meta = e.meta, "" === this.name && (this.name = e.name)
            }
            ...
            a.call(this), e.extend(this, {
                ...
                embed: function (i, r) {
                    function o(t, r) {
                        ...
                        if (u.can("use_data_uri_of", d.length)) i.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" />', o.destroy(), a.trigger("embedded"); else {
                            var f = new s;
        ...
        function c() {
            function e(e, t) {
                ...
                i = t.getBlob().getSource(), r = new window.FileReader, r.onload = function () {
                    t.append(t.getBlobName(), new o(null, {type: i.type, data: r.result})), h.send.call(n, e, t)
            ...
            t.extend(this, {
                send: function (n, r) {
                    ...
                    if (p = n.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), f = c(), f.open(n.method, n.url, n.async, n.user, n.password), r instanceof o) r.isDetached() && (m = !0), r = r.getSource(); else if (r instanceof a) {
                        if (r.hasBlob()) if (r.getBlob().isDetached()) r = d.call(s, r), m = !0; else if ((l || h) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return void e.call(s, n, r);
                        if (r instanceof a) {
        ...
        return e.extend(t.prototype, {
            littleEndian: !1, read: function (e, t) {
                ...
                for (i = this.littleEndian ? 0 : -8 * (n - 1), r = 0; n > r; r++) this.writeByteAt(e + r, t >> Math.abs(i + 8 * r) & 255)
            }, BYTE: function (e) {
        ...
        return function n(i) {
            ...
            for (a = 2; a <= o.length();) if (s = o.SHORT(a), s >= 65488 && 65495 >= s) a += 2; else {
        ...
        function r(o) {
            function a(n, r) {
                ...
                for (a = o.SHORT(n), s = 0; a > s; s++) if (g = [], p = n + 2 + 12 * s, u = r[o.SHORT(p)], u !== t) {
                    if (c = w[o.SHORT(p += 2)], h = o.LONG(p += 2), f = y[c], !f) throw new i.ImageError(i.ImageError.INVALID_META_ERR);
                    if (p += 4, f * h > 4 && (p = o.LONG(p) + d.tiffHeader), p + f * h >= this.length()) throw new i.ImageError(i.ImageError.INVALID_META_ERR);
            ...
            function s(e, t, n) {
                ...
                for (var l = 0; r > l; l++) if (o = i + 12 * l + 2, this.SHORT(o) == t) {
                    a = o + 8;
                    break
                }
                if (!a) return !1;
            ...
            }), 65505 !== this.SHORT(0) || "EXIF\x00" !== this.STRING(4, 5).toUpperCase()) throw new i.ImageError(i.ImageError.INVALID_META_ERR);
        ...
        function i(i) {
            ...
            s = new n(i), function () {
                ...
                for (n = 0; n < i.length; n++, t += 2) if (i[n] != s.SHORT(t)) throw new e.ImageError(e.ImageError.WRONG_FORMAT)
        ...
        function e(e, i, r) {
            ...
            for (var p = f.getContext("2d"), m = n(e, o, a), g = 0; a > g;) {
                for (var v = g + h > a ? a - g : h, w = 0; o > w;) {
                    ...
                    var E = w * s / o + c << 0, _ = Math.ceil(y * s / o), b = g * u / a / m + l << 0,
                        x = Math.ceil(v * u / a / m);
        ...
        function l() {
            function e() {
                if (!E && !w) throw new n.ImageError(n.DOMException.INVALID_STATE_ERR);
                return E || w
            }
            ...
            function d(e) {
                var t = this;
                w = new Image, w.onerror = function () {
                    g.call(this), t.trigger("error", n.ImageError.WRONG_FORMAT)
                }, w.onload = function () {
                    t.trigger("load")
                }, w.src = "data:" == e.substr(0, 5) ? e : l(e, b.type)
            }
            ...
            function f(n, i, r, o) {
                var a = this, s, u, c = 0, l = 0, d, h, f, g;
                if (R = o, g = this.meta && this.meta.tiff && this.meta.tiff.Orientation || 1, -1 !== t.inArray(g, [5, 6, 7, 8])) {
                    var v = n;
                    n = i, i = v
                }
                return d = e(), r ? (n = Math.min(n, d.width), i = Math.min(i, d.height), s = Math.max(n / d.width, i / d.height)) : s = Math.min(n / d.width, i / d.height), s > 1 && !r && o ? void this.trigger("Resize") : (E || (E = document.createElement("canvas")), h = Math.round(d.width * s), f = Math.round(d.height * s), r ? (E.width = n, E.height = i, h > n && (c = Math.round((h - n) / 2)), f > i && (l = Math.round((f - i) / 2))) : (E.width = h, E.height = f), R || m(E.width, E.height, g), p.call(this, d, E, -c, -l, h, f), this.width = E.width, this.height = E.height, x = !0, void a.trigger("Resize"))
            }

            function p(e, t, n, i, r, o) {
                if ("iOS" === c.OS) s.renderTo(e, t, {width: r, height: o, x: n, y: i}); else {
            ...
            function g() {
                y && (y.purge(), y = null), _ = w = E = b = null, x = !1
            }

            var v = this, w, y, E, _, b, x = !1, R = !0;
            t.extend(this, {
                loadFromBlob: function (e) {
                    var t = this, i = t.getRuntime(), o = arguments.length > 1 ? arguments[1] : !0;
                    if (!i.can("access_binary")) throw new n.RuntimeError(n.RuntimeError.NOT_SUPPORTED_ERR);
                    return b = e, e.isDetached() ? (_ = e.getSource(), void d.call(this, _)) : void h.call(this, e.getSource(), function (e) {
                        o && (_ = r(e)), d.call(t, e)
                    })
                    ...
                    var t = this.getRuntime(), n;
                    return !y && _ && t.can("access_image_binary") && (y = new a(_)), n = {
                        width: e().width || 0,
                        height: e().height || 0,
                        type: b.type || u.getFileMime(b.name),
                        size: _ && _.length || b.size || 0,
                        name: b.name || "",
                    ...
                    return e !== this.type && f.call(this, this.width, this.height, !1), new o(null, {
                        name: b.name || "",
                        type: e,
                    ...
                    if (!x) return _ || (_ = r(v.getAsDataURL(e, t))), _;
                    if ("image/jpeg" !== e) _ = r(v.getAsDataURL(e, t)); else {
                        var n;
                        t || (t = 90);
                        try {
                        ...
                        _ = r(n), y && (_ = y.stripHeaders(_), R && (y.meta && y.meta.exif && y.setExif({
                            PixelXDimension: this.width,
                            PixelYDimension: this.height
                        }), _ = y.writeHeaders(_)), y.purge(), y = null)
                    }
                    return x = !1, _
                }, destroy: function () {
        ...
        return e.Image = t.extend({}, i, {
            getInfo: function () {
                var e = this.getRuntime(), n = ["tiff", "exif", "gps", "thumb"], i = {meta: {}},
        ...
        function s() {
            function e() {
                ...
                g = n.guid("uid_"), d = l.getShimContainer(), s && (f = i.get(s + "_form"), f && n.extend(f.style, {top: "100%"})), p = document.createElement("form"), p.setAttribute("id", g + "_form"), p.setAttribute("method", "post"), p.setAttribute("enctype", "multipart/form-data"), p.setAttribute("encoding", "multipart/form-data"), n.extend(p.style, {
                    ...
                    if (this.value) {
                        if (this.files) {
                            if (n = this.files[0], 0 === n.size) return void p.parentNode.removeChild(p)
            ...
            n.extend(this, {
                init: function (t) {
                    ...
                    }(), e.call(this), s = null, n.trigger({type: "ready", async: !0})
                }, disable: function (e) {
                    var t;
            ...
            t.extend(this, {
                send: function (d, h) {
                    ...
                    if (u = c = null, h instanceof s && h.hasBlob()) {
                        if (y = h.getBlob(), g = y.uid, w = n.get(g), v = n.get(g + "_form"), !v) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR)
                    } else g = t.guid("uid_"), v = document.createElement("form"), v.setAttribute("id", g + "_form"), v.setAttribute("method", d.method), v.setAttribute("enctype", "multipart/form-data"), v.setAttribute("encoding", "multipart/form-data"), m.getShimContainer().appendChild(v);
                    v.setAttribute("target", g + "_iframe"), h instanceof s && h.each(function (e, n) {
                        if (e instanceof a) w && w.setAttribute("name", n); else {
