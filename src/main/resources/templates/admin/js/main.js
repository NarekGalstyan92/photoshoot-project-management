$(document).ready(function () {
    ...
    $(".accordion-menu .has-sub.active-page > a").addClass("active"), $(".current-year").text((new Date).getFullYear()), $(".page-sidebar-inner").slimScroll({height: "100%"}).mouseover(), l.hasClass("page-sidebar-fixed") && !1 === e && (e = !0), !0 === e && (l.addClass("page-sidebar-fixed"), $("#fixed-sidebar-toggle-button").removeClass("icon-radio_button_unchecked"), $("#fixed-sidebar-toggle-button").addClass("icon-radio_button_checked")), $("#fixed-sidebar-toggle-button").on("click", function () {
        return l.toggleClass("page-sidebar-fixed"), e = !!l.hasClass("page-sidebar-fixed"), $(this).toggleClass("icon-radio_button_unchecked"), $(this).toggleClass("icon-radio_button_checked"), !1
    }), !0 === t && l.addClass("page-sidebar-collapsed"), $(".page-sidebar-collapsed .page-sidebar .accordion-menu").on({
        mouseenter: function () {
        ...
        return l.toggleClass("page-sidebar-collapsed"), t = !!l.hasClass("page-sidebar-collapsed"), $(".page-sidebar-collapsed .page-sidebar .accordion-menu").on({
            mouseenter: function () {
                $(".page-sidebar").addClass("fixed-sidebar-scroll")
            }, mouseleave: function () {
                $(".page-sidebar").removeClass("fixed-sidebar-scroll")
        ...
        $(".page-sidebar li:not(.open) .sub-menu"), $(".page-sidebar li.active-page > a"), $(".accordion-menu li ul li").parent().addClass("sub-menu"), $(".accordion-menu li ul").parent().addClass("has-sub");
        var e = window.location.pathname.split("/"), t = window.location.pathname,
            t = 0 < e[e.length - 1].length ? e[e.length - 1] : e[e.length - 2];
        $(".accordion-menu li").find('a[href="' + t + '"]').closest("li").addClass("active").parents().eq(1).addClass("active-page"), $(".accordion-menu .active-page > a").addClass("active"), $(".has-sub > a").on("click", function (e) {
            return e.preventDefault(), $(this).toggleClass("active"), $(this).next(".sub-menu").slideToggle(), $(this).parents().siblings(".has-sub").children(".sub-menu").slideUp().prev(".active").removeClass("active")
        })
        ...
        $(".right-sidebar-chat").slimscroll({allowPageScroll: !0, scrollTo: e})
    }), function () {
        ...
        0 < e.length && e.each(function () {
            ...
            new Switchery(e, {size: "small", color: "#526069"})
        })
    }()
});